...
namespace BearingCAD21
{
    public partial class frmBearingDesignDetails : Form
    {
        ...
        //****************************
            ...
            #region "....SET CONTROLS ROUTINES:"
                ...
                //=======================                           
                {
                    ...
                    ////if (mBearing_Radial_FP.AntiRotPin.Spec.Unit.System.ToString() == clsUnit.eSystem.English.ToString())
                    ////{
                    ////    cmbAntiRotPin_Spec_UnitSystem.Enabled = true;
                    ////    cmbSL_Screw_Spec_UnitSystem.Enabled = true;
                    ////    cmbSL_Dowel_Spec_UnitSystem.Enabled = true;
                    ////}
                    ////else
                    ////{
                    ////    cmbAntiRotPin_Spec_UnitSystem.Enabled = false;
                    ////    cmbSL_Screw_Spec_UnitSystem.Enabled = false;
                    ////    cmbSL_Dowel_Spec_UnitSystem.Enabled = false;
                    ////}
                }
                ...
                //===============================================
                {
                    ...
                    //
                        ...
                        //-----
                            ...
                            cmbSL_Dowel_Spec_UnitSystem.Enabled = false; // Enabled_In; //AES 14AUG18
                    ...
                    //....Mounting Holes.                    
                        ...
                        //
                            ...
                            ////{
                                ...
                                txtMount_Fixture_DBC_Front.ReadOnly = false;
                                if (!Enabled_In)
                        ...
                        //  -----
                            ...
                            ////{
                                ...
                                txtMount_Fixture_DBC_Back.ReadOnly = false;
                                if (!Enabled_In)
            ...
            #region "Display Data:"
                ...
                //========================
                {
                    ...
                    {
                        txtL.Text = modMain.gProject.Unit.WriteInUserL(modMain.gProject.Unit.CEng_Met(mBearing_Radial_FP.L));
                    }
                    else
                    {
                        txtL.Text = modMain.gProject.Unit.WriteInUserL(mBearing_Radial_FP.L);
                    }
                    ...
                    if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                    {
                        if (mBearing_Radial_FP.Depth_EndConfig[0] != 0.0)
                        {
                            ...
                            {
                                txtDepth_EndConfig_Front.Text = modMain.gProject.Unit.WriteInUserL(modMain.gProject.Unit.CEng_Met(mBearing_Radial_FP.Depth_EndConfig[0]));
                            }
                            else
                            {
                                txtDepth_EndConfig_Front.Text =modMain.gProject.Unit.WriteInUserL( modMain.gProject.Unit.CEng_Met(mBearing_Radial_FP.Calc_Depth_EndConfig()));
                            }
                        }
                        ...
                        if (mBearing_Radial_FP.Depth_EndConfig[1] != 0.0)
                        {
                            ...
                            {
                                txtDepth_EndConfig_Back.Text = modMain.gProject.Unit.WriteInUserL(modMain.gProject.Unit.CEng_Met(mBearing_Radial_FP.Depth_EndConfig[1]));
                            }
                            else
                            {
                                txtDepth_EndConfig_Back.Text =modMain.gProject.Unit.WriteInUserL( modMain.gProject.Unit.CEng_Met(mBearing_Radial_FP.Calc_Depth_EndConfig()));
                            }
                        }
                    }
                    else
                    {
                        if (mBearing_Radial_FP.Depth_EndConfig[0] != 0.0)
                        {
                            if (Math.Abs(mBearing_Radial_FP.Depth_EndConfig[0] - mBearing_Radial_FP.Calc_Depth_EndConfig()) > modMain.gcEPS)
                            {
                                txtDepth_EndConfig_Front.Text = modMain.gProject.Unit.WriteInUserL(mBearing_Radial_FP.Depth_EndConfig[0]);
                            }
                            else
                            {
                                txtDepth_EndConfig_Front.Text =modMain.gProject.Unit.WriteInUserL( mBearing_Radial_FP.Calc_Depth_EndConfig());
                            }
                        }
                        ...
                        if (mBearing_Radial_FP.Depth_EndConfig[1] != 0.0)
                        {
                            if (Math.Abs(mBearing_Radial_FP.Depth_EndConfig[1] - mBearing_Radial_FP.Calc_Depth_EndConfig()) > modMain.gcEPS)
                            {
                                txtDepth_EndConfig_Back.Text = modMain.gProject.Unit.WriteInUserL(mBearing_Radial_FP.Depth_EndConfig[1]);
                            }
                            else
                            {
                                txtDepth_EndConfig_Back.Text =modMain.gProject.Unit.WriteInUserL( mBearing_Radial_FP.Calc_Depth_EndConfig());
                            }
                        }
                    }
                    ...
                    //-----------------
                        ...
                        //....Start Dim                   
                    txtRoughing_DimStart_FrontFace.Text = modMain.gProject.Unit.WriteInUserL(mBearing_Radial_FP.DimStart_FrontFace);

                        //....Fixture Hole Location B                    
                    txtRoughing_Loc_Fixture_B.Text = modMain.gProject.Unit.WriteInUserL(mBearing_Radial_FP.Loc_Fixture_B());
                    ...
                    //  ---------------
                        ...
                        //....Orifice
                            ...
                            if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                            {
                                txtOilInlet_Orifice_DDrill_CBore.Text = modMain.gProject.Unit.WriteInUserL(modMain.gProject.Unit.CEng_Met(mBearing_Radial_FP.OilInlet.Orifice.DDrill_CBore));
                                txtOilInlet_Orifice_Loc_FrontFace.Text = modMain.gProject.Unit.WriteInUserL(modMain.gProject.Unit.CEng_Met(mBearing_Radial_FP.OilInlet.Orifice.Loc_FrontFace));
                                txtOilInlet_Orifice_L.Text = modMain.gProject.Unit.WriteInUserL(modMain.gProject.Unit.CEng_Met(mBearing_Radial_FP.OilInlet.Orifice.L));                                
                            }
                            else
                            {
                                txtOilInlet_Orifice_DDrill_CBore.Text = modMain.gProject.Unit.WriteInUserL(mBearing_Radial_FP.OilInlet.Orifice.DDrill_CBore);
                                txtOilInlet_Orifice_Loc_FrontFace.Text = modMain.gProject.Unit.WriteInUserL(mBearing_Radial_FP.OilInlet.Orifice.Loc_FrontFace);
                                txtOilInlet_Orifice_L.Text = modMain.gProject.Unit.WriteInUserL(mBearing_Radial_FP.OilInlet.Orifice.L);
                                
                            }
                            txtOilInlet_Orifice_AngStart_BDV.Text = modMain.gProject.Unit.WriteInUserL(mBearing_Radial_FP.OilInlet.Orifice.AngStart_BDV);
                        ...
                        //....Annulus 
                            ...
                            if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                            {
                                ...
                                {
                                    txtOilInlet_Annulus_D.Text = modMain.gProject.Unit.WriteInUserL(modMain.gProject.Unit.CEng_Met(mBearing_Radial_FP.OilInlet.Annulus.D));
                                    txtOilInlet_Annulus_L.Text = modMain.gProject.Unit.WriteInUserL(modMain.gProject.Unit.CEng_Met(mBearing_Radial_FP.OilInlet.Annulus.L));
                                    ...
                                    else
                                    {
                                        cmbOilInlet_Annulus_Ratio_L_H.Text = mBearing_Radial_FP.OilInlet.Calc_Annulus_Ratio_L_H
                                                                            (modMain.gProject.Unit.CMet_Eng(modMain.ConvTextToDouble(txtOilInlet_Annulus_D.Text)), modMain.gProject.Unit.CMet_Eng(modMain.ConvTextToDouble(txtOilInlet_Annulus_L.Text))).ToString("#0.00");      //BG 16MAY12

                                        txtOilInlet_Annulus_D.ForeColor = Color.Black;
                                        txtOilInlet_Annulus_L.ForeColor = Color.Black;
                                    }

                                    txtOilInlet_Annulus_V.Text = modMain.gProject.Unit.WriteInUserL(mBearing_Radial_FP.OilInlet.Annulus_V(modMain.ConvTextToDouble(txtOilInlet_Annulus_D.Text), modMain.ConvTextToDouble(txtOilInlet_Annulus_L.Text)));
                                    txtOilInlet_Annulus_Loc_Back.Text = modMain.gProject.Unit.WriteInUserL(modMain.gProject.Unit.CEng_Met(mBearing_Radial_FP.OilInlet.Annulus.Loc_Back));
                                }
                                ...
                                if (mBearing_Radial_FP.OilInlet.Orifice_Exists_2ndSet())
                                {
                                    txtOilInlet_Orifice_Dist_Holes.Text = modMain.gProject.Unit.WriteInUserL(modMain.gProject.Unit.CEng_Met(mBearing_Radial_FP.OilInlet.Orifice.Dist_Holes));
                                }
                            }
                            else
                            {
                                if (chkOilInlet_Annulus_Exists.Checked)
                                {
                                    txtOilInlet_Annulus_D.Text = modMain.gProject.Unit.WriteInUserL(mBearing_Radial_FP.OilInlet.Annulus.D);
                                    txtOilInlet_Annulus_L.Text = modMain.gProject.Unit.WriteInUserL(mBearing_Radial_FP.OilInlet.Annulus.L);
                                    if (mBearing_Radial_FP.OilInlet.Annulus.D < modMain.gcEPS && mBearing_Radial_FP.OilInlet.Annulus.L < modMain.gcEPS)
                                    {
                                        cmbOilInlet_Annulus_Ratio_L_H.SelectedIndex = 0;
                                        //....Decide whether it is calculated or not.
                                    ...
                                    txtOilInlet_Annulus_V.Text = modMain.gProject.Unit.WriteInUserL(mBearing_Radial_FP.OilInlet.Annulus_V(modMain.ConvTextToDouble(txtOilInlet_Annulus_D.Text), modMain.ConvTextToDouble(txtOilInlet_Annulus_L.Text)));
                                    txtOilInlet_Annulus_Loc_Back.Text = modMain.gProject.Unit.WriteInUserL(mBearing_Radial_FP.OilInlet.Annulus.Loc_Back);
                                }
                                ...
                                if (mBearing_Radial_FP.OilInlet.Orifice_Exists_2ndSet())
                                {
                                    txtOilInlet_Orifice_Dist_Holes.Text = modMain.gProject.Unit.WriteInUserL(mBearing_Radial_FP.OilInlet.Orifice.Dist_Holes);
                                }
                            }
                    ...
                    //  -----------------
                            ...
                            if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                            {
                                txtMillRelief_D_PadRelief.Text = modMain.gProject.Unit.WriteInUserL(modMain.gProject.Unit.CEng_Met(mBearing_Radial_FP.MillRelief.D_PadRelief()));
                                ...
                                for (int i = 0; i < 2; i++)        
                                {
                                    mtxtEDM_Relief[i].Text = modMain.gProject.Unit.WriteInUserL(modMain.gProject.Unit.CEng_Met(mBearing_Radial_FP.MillRelief.EDM_Relief[i]));
                                }
                            }
                            else
                            {
                                txtMillRelief_D_PadRelief.Text = modMain.gProject.Unit.WriteInUserL(mBearing_Radial_FP.MillRelief.D_PadRelief());
                                chkMillRelief_Exists.Checked = mBearing_Radial_FP.MillRelief.Exists;
                                SetControl_Web_MillRelief();
                                cmbMillRelief_D_Desig.Text = mBearing_Radial_FP.MillRelief.D_Desig;
                                ...
                                for (int i = 0; i < 2; i++)         
                                {
                                    mtxtEDM_Relief[i].Text = modMain.gProject.Unit.WriteInUserL(mBearing_Radial_FP.MillRelief.EDM_Relief[i]);
                                }
                            }
                    ...
                    //  -------------------------  
                        ...
                        //....Screw.
                        cmbSL_Screw_Spec_UnitSystem.Text =mBearing_Radial_FP.SL.Screw_Spec.Unit.System.ToString();      
                        ...
                        if (mBearing_Radial_FP.SL.Screw_Spec.Pitch != 0.0F)
                            cmbSL_Screw_Spec_Pitch.Text = modMain.gProject.Unit.WriteInUserL(mBearing_Radial_FP.SL.Screw_Spec.Pitch);
                        ...
                        if (mBearing_Radial_FP.SL.Screw_Spec.L != 0.0F)
                            cmbSL_Screw_Spec_L.Text = modMain.gProject.Unit.WriteInUserL(mBearing_Radial_FP.SL.Screw_Spec.L);
                        ...
                        if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                        {
                            txtSL_LScrew_Loc_Center.Text = modMain.gProject.Unit.WriteInUserL(modMain.gProject.Unit.CEng_Met(mBearing_Radial_FP.SL.LScrew_Loc.Center));
                            txtSL_LScrew_Loc_Front.Text = modMain.gProject.Unit.WriteInUserL(modMain.gProject.Unit.CEng_Met(mBearing_Radial_FP.SL.LScrew_Loc.Front));

                            txtSL_RScrew_Loc_Center.Text = modMain.gProject.Unit.WriteInUserL(modMain.gProject.Unit.CEng_Met(mBearing_Radial_FP.SL.RScrew_Loc.Center));
                            txtSL_RScrew_Loc_Front.Text = modMain.gProject.Unit.WriteInUserL(modMain.gProject.Unit.CEng_Met(mBearing_Radial_FP.SL.RScrew_Loc.Front));

                            txtSL_Thread_Depth.Text = modMain.gProject.Unit.WriteInUserL(modMain.gProject.Unit.CEng_Met(mBearing_Radial_FP.SL.Thread_Depth));
                            txtSL_CBore_Depth.Text = modMain.gProject.Unit.WriteInUserL(modMain.gProject.Unit.CEng_Met(mBearing_Radial_FP.SL.CBore_Depth));
                        }
                        else
                        {
                            txtSL_LScrew_Loc_Center.Text = modMain.gProject.Unit.WriteInUserL(mBearing_Radial_FP.SL.LScrew_Loc.Center);
                            txtSL_LScrew_Loc_Front.Text = modMain.gProject.Unit.WriteInUserL(mBearing_Radial_FP.SL.LScrew_Loc.Front);

                            txtSL_RScrew_Loc_Center.Text = modMain.gProject.Unit.WriteInUserL(mBearing_Radial_FP.SL.RScrew_Loc.Center);
                            txtSL_RScrew_Loc_Front.Text = modMain.gProject.Unit.WriteInUserL(mBearing_Radial_FP.SL.RScrew_Loc.Front);

                            txtSL_Thread_Depth.Text = modMain.gProject.Unit.WriteInUserL(mBearing_Radial_FP.SL.Thread_Depth);
                            txtSL_CBore_Depth.Text = modMain.gProject.Unit.WriteInUserL(mBearing_Radial_FP.SL.CBore_Depth);
                        }
                        ...
                        cmbSL_Dowel_Spec_UnitSystem.Text = mBearing_Radial_FP.SL.Screw_Spec.Unit.System.ToString();  
                        ...
                        if (mBearing_Radial_FP.SL.Dowel_Spec.L != 0.0F)
                            cmbSL_Dowel_Spec_L.Text = modMain.gProject.Unit.WriteInUserL(mBearing_Radial_FP.SL.Dowel_Spec.L);
                        ...
                        if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                        {
                            txtSL_LDowel_Loc_Center.Text = modMain.gProject.Unit.WriteInUserL(modMain.gProject.Unit.CEng_Met(mBearing_Radial_FP.SL.LDowel_Loc.Center));
                            txtSL_LDowel_Loc_Front.Text = modMain.gProject.Unit.WriteInUserL(modMain.gProject.Unit.CEng_Met(mBearing_Radial_FP.SL.LDowel_Loc.Front));

                            txtSL_RDowel_Loc_Center.Text = modMain.gProject.Unit.WriteInUserL(modMain.gProject.Unit.CEng_Met(mBearing_Radial_FP.SL.RDowel_Loc.Center));
                            txtSL_RDowel_Loc_Front.Text = modMain.gProject.Unit.WriteInUserL(modMain.gProject.Unit.CEng_Met(mBearing_Radial_FP.SL.RDowel_Loc.Front));

                            txtSL_Dowel_Depth.Text = modMain.gProject.Unit.WriteInUserL(modMain.gProject.Unit.CEng_Met(mBearing_Radial_FP.SL.Dowel_Depth));
                        }
                        else
                        {
                            txtSL_LDowel_Loc_Center.Text = modMain.gProject.Unit.WriteInUserL(mBearing_Radial_FP.SL.LDowel_Loc.Center);
                            txtSL_LDowel_Loc_Front.Text = modMain.gProject.Unit.WriteInUserL(mBearing_Radial_FP.SL.LDowel_Loc.Front);

                            txtSL_RDowel_Loc_Center.Text = modMain.gProject.Unit.WriteInUserL(mBearing_Radial_FP.SL.RDowel_Loc.Center);
                            txtSL_RDowel_Loc_Front.Text = modMain.gProject.Unit.WriteInUserL(mBearing_Radial_FP.SL.RDowel_Loc.Front);

                            txtSL_Dowel_Depth.Text = modMain.gProject.Unit.WriteInUserL(mBearing_Radial_FP.SL.Dowel_Depth);
                        }
                    ...
                    //  -----------------------
                        ...
                        if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                        {
                            txtAntiRotPin_Loc_Dist_Front.Text = modMain.gProject.Unit.WriteInUserL(modMain.gProject.Unit.CEng_Met(mBearing_Radial_FP.AntiRotPin.Loc_Dist_Front));
                        }
                        else
                        {
                            txtAntiRotPin_Loc_Dist_Front.Text = modMain.gProject.Unit.WriteInUserL(mBearing_Radial_FP.AntiRotPin.Loc_Dist_Front);
                        }
                        ...
                        if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                        {
                            txtAntiRotPin_Loc_Offset.Text = modMain.gProject.Unit.WriteInUserL(modMain.gProject.Unit.CEng_Met(mBearing_Radial_FP.AntiRotPin.Loc_Offset));
                        }
                        else
                        {
                            txtAntiRotPin_Loc_Offset.Text = modMain.gProject.Unit.WriteInUserL(mBearing_Radial_FP.AntiRotPin.Loc_Offset);
                        }
                        ...
                        if (mBearing_Radial_FP.AntiRotPin.Spec.L != 0.0F)
                            cmbAntiRotPin_Spec_L.Text = modMain.gProject.Unit.WriteInUserL(mBearing_Radial_FP.AntiRotPin.Spec.L);      
                        else if (cmbAntiRotPin_Spec_L.Items.Count > 0)
                            cmbAntiRotPin_Spec_L.SelectedIndex = 0;

                        if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                        {
                            txtAntiRotPin_Depth.Text = modMain.gProject.Unit.WriteInUserL(modMain.gProject.Unit.CEng_Met(mBearing_Radial_FP.AntiRotPin.Depth));
                            txtAntiRotPin_Stickout.Text = modMain.gProject.Unit.WriteInUserL(modMain.gProject.Unit.CEng_Met(mBearing_Radial_FP.AntiRotPin.Stickout));
                        }
                        else
                        {
                            txtAntiRotPin_Depth.Text = modMain.gProject.Unit.WriteInUserL(mBearing_Radial_FP.AntiRotPin.Depth);
                            txtAntiRotPin_Stickout.Text = modMain.gProject.Unit.WriteInUserL(mBearing_Radial_FP.AntiRotPin.Stickout);
                        }
                    ...
                    //  --------------------
                        ...
                        for (int i = 0; i < 2; i++)
                        {
                            ...
                            if (chkMount_Holes_Bolting_Front.Checked && i == 0)                       
                            {
                                if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                                {
                                    txtMount_Holes_Thread_Depth_Front.Text = modMain.gProject.Unit.WriteInUserL(modMain.gProject.Unit.CEng_Met(mBearing_Radial_FP.Mount.Holes_Thread_Depth[i]));
                                }
                                else
                                {
                                    txtMount_Holes_Thread_Depth_Front.Text = modMain.gProject.Unit.WriteInUserL(mBearing_Radial_FP.Mount.Holes_Thread_Depth[i]);
                                }

                                Display_Candidate_Fixture_Details(mBearing_Radial_FP, i);
                                ...
                                ////{
                                    ...
                                    if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                                    {
                                        txtMount_Fixture_WallT_Front.Text = modMain.gProject.Unit.WriteInUserL(modMain.gProject.Unit.CEng_Met(mBearing_Radial_FP.Mount.TWall_BearingCB(i)));
                                    }
                                    else
                                    {
                                        txtMount_Fixture_WallT_Front.Text = modMain.gProject.Unit.WriteInUserL(mBearing_Radial_FP.Mount.TWall_BearingCB(i));
                                    }
                                    ...
                                    if (mBearing_Radial_FP.Mount.Fixture[i].Screw_Spec.L != 0.0F)
                                        cmbMount_Fixture_Screw_L_Front.Text = modMain.gProject.Unit.WriteInUserL(mBearing_Radial_FP.Mount.Fixture[i].Screw_Spec.L);
                                ...
                                lblMount_Fixture_Unit_Front.Text = cmbSL_Screw_Spec_UnitSystem.Text;
                            ...
                            if (chkMount_Holes_Bolting_Back.Checked && i == 1)                        
                            {
                                if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                                {
                                    txtMount_Holes_Thread_Depth_Back.Text = modMain.gProject.Unit.WriteInUserL(modMain.gProject.Unit.CEng_Met(mBearing_Radial_FP.Mount.Holes_Thread_Depth[i]));
                                }
                                else
                                {
                                    txtMount_Holes_Thread_Depth_Back.Text = modMain.gProject.Unit.WriteInUserL(mBearing_Radial_FP.Mount.Holes_Thread_Depth[i]);
                                }
                                Display_Candidate_Fixture_Details(mBearing_Radial_FP, i);
                                ...
                                ////{
                                    ...
                                    if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                                    {
                                        txtMount_Fixture_WallT_Back.Text = modMain.gProject.Unit.WriteInUserL(modMain.gProject.Unit.CEng_Met(mBearing_Radial_FP.Mount.TWall_BearingCB(i)));
                                    }
                                    else
                                    {
                                        txtMount_Fixture_WallT_Back.Text = modMain.gProject.Unit.WriteInUserL(mBearing_Radial_FP.Mount.TWall_BearingCB(i));
                                    }
                                    ...
                                    //........Length.
                                    if (mBearing_Radial_FP.Mount.Fixture[i].Screw_Spec.L != 0.0F)
                                        cmbMount_Fixture_Screw_L_Back.Text = modMain.gProject.Unit.WriteInUserL(mBearing_Radial_FP.Mount.Fixture[i].Screw_Spec.L);
                                ...
                                lblMount_Fixture_Unit_Back.Text = cmbSL_Screw_Spec_UnitSystem.Text;
                    ...
                    //  -----------------------
                        ...
                        txtTempSensor_D.Text = modMain.gProject.Unit.WriteInUserL(mBearing_Radial_FP.TempSensor.D);
                        txtTempSensor_Depth.Text = modMain.gProject.Unit.WriteInUserL(mBearing_Radial_FP.TempSensor.Depth);
                    ...
                    #region "EDM:"
                    //------------
                        txtEDM_Pad_RFilletBack.Text = modMain.gProject.Unit.WriteInUserL(mBearing_Radial_FP.EDM_Pad.RFillet_Back);
                        txtEDM_PAD_Offset.Text = modMain.gProject.Unit.WriteInUserL(mBearing_Radial_FP.EDM_Pad.Ang_Offset(modMain.gOpCond));
            ...
            #region "ROUTINE RELATED CALCULATED FIELD"
                ...
                //==========================================================
                {
                    ...
                    if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                    {
                        TxtBox_In.Text = modMain.gProject.Unit.WriteInUserL(modMain.gProject.Unit.CEng_Met(mBearing_Radial_FP.Mount.Fixture[0].DBC));
                    }
                    else
                    {
                        TxtBox_In.Text = modMain.gProject.Unit.WriteInUserL(mBearing_Radial_FP.Mount.Fixture[0].DBC);
                    }
                    TxtBox_In.ForeColor = Color.Black;
                }
                ...
                //=========================================================
                {
                    ...
                    if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                    {
                        TxtBox_In.Text = modMain.gProject.Unit.WriteInUserL(modMain.gProject.Unit.CEng_Met(mBearing_Radial_FP.Mount.Fixture[0].D_Finish));
                    }
                    else
                    {
                        TxtBox_In.Text = modMain.gProject.Unit.WriteInUserL(mBearing_Radial_FP.Mount.Fixture[0].D_Finish);
                    }
                    TxtBox_In.ForeColor = Color.Black;
                }
            ...
            #region "UTILITY LOAD ROUTINES"
                ...
                #region "OilInlet:"
                    ...
                    //=============================================   
                    {
                        if (mBearing_Radial_FP.OilInlet.Orifice_Exists_2ndSet())
                        {
                            if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                            {
                                txtOilInlet_Orifice_Dist_Holes.Text = modMain.ConvDoubleToStr(modMain.gProject.Unit.CEng_Met(mBearing_Radial_FP.OilInlet.Orifice.Dist_Holes), "#0.000");
                            }
                            else
                            {
                ...
                #region "AntiRotPin:"
                    ...
                    //===============================================
                    {
                        ...
                        var pQry_Manf_Pin = (from pRec in pBearingDBEntities.tblManf_Pin where pRec.fldUnit == pUnit orderby 
                                             pRec.fldType ascending select pRec.fldType).Distinct().ToList();
                ...
                #region "MountHoles:"
                    ...
                    //===========================================================
                    {
                        Upadate_Fixture_Selection(mBearing_Radial_FP);      //AES 30JUL18   To be reviewed later.
                        Bearing_In.Mount.Holes_GoThru = false;
                        //Bearing_In.Mount.Fixture[0].HolesEquiSpaced = true;
                        //Bearing_In.Mount.Fixture[1].HolesEquiSpaced = true;
                        //Bearing_In.Mount.Fixture[0].HolesCount = 4;
                        //Bearing_In.Mount.Fixture[0].HolesAngStart = 60;                        
                        //Bearing_In.Mount.Fixture[1].HolesCount = 4;
                        //Bearing_In.Mount.Fixture[1].HolesAngStart = 60;
                    ...
                    //=====================================================       
                    {
                        ...
                        switch (MountHolePos_In)
                        {
                            ...
                            //----------
                                ...
                                if (mBearing_Radial_FP.Mount.Fixture[0].Screw_Spec.Type == ""
                                    || cmbMount_Fixture_Screw_Type_Front.Items.Count == 0)
                                    {
                                        //.....Type.
                                        var pQry_Manf_Screw_Front = (from pRec in pBearingDBEntities.tblManf_Screw where pRec.fldUnit == pUnit orderby pRec.fldType ascending select pRec.fldType).Distinct().ToList();
                                        cmbMount_Fixture_Screw_Type_Front.Items.Clear();
                                        if (pQry_Manf_Screw_Front.Count() > 0)
                                        {
                                            for (int i = 0; i < pQry_Manf_Screw_Front.Count; i++)
                                            {
                                                cmbMount_Fixture_Screw_Type_Front.Items.Add(pQry_Manf_Screw_Front[i]);
                                            }
                                        }
                                        int pIndx = cmbMount_Fixture_Screw_Type_Front.Items.IndexOf("SHCS");

                                        //.....Material.
                                        var pQry_Manf_Screw_Mat_Front = (from pRec in pBearingDBEntities.tblManf_Screw
                                                                         where pRec.fldUnit == pUnit
                                                                         orderby pRec.fldType ascending
                                                                         select pRec.fldMat).Distinct().ToList();

                                        cmbMount_Fixture_Screw_Mat_Front.Items.Clear();
                                        if (pQry_Manf_Screw_Mat_Front.Count() > 0)
                                        {
                                            for (int i = 0; i < pQry_Manf_Screw_Mat_Front.Count; i++)
                                            {
                                                cmbMount_Fixture_Screw_Mat_Front.Items.Add(pQry_Manf_Screw_Mat_Front[i]);
                                            }
                                        }
                                        ...
                                        if (pQry_Manf_Screw_Mat_Front.Count > 0)
                                        {
                                            cmbMount_Fixture_Screw_Mat_Front.SelectedIndex = pIndx;
                                        }
                                    }
                            ...
                            //----------
                               ...
                               ////     || cmbMount_Fixture_Screw_Type_Back.Items.Count == 0)
                                if (mBearing_Radial_FP.Mount.Fixture[1].Screw_Spec.Type == ""
                                   || cmbMount_Fixture_Screw_Type_Back.Items.Count == 0)
                                {
                                    //.....Type.
                                    var pQry_Manf_Screw_Back = (from pRec in pBearingDBEntities.tblManf_Screw where pRec.fldUnit == pUnit orderby pRec.fldType ascending select pRec.fldType).Distinct().ToList();
                                    cmbMount_Fixture_Screw_Type_Back.Items.Clear();
                                    if (pQry_Manf_Screw_Back.Count() > 0)
                                    {
                                        for (int i = 0; i < pQry_Manf_Screw_Back.Count; i++)
                                        {
                                            cmbMount_Fixture_Screw_Type_Back.Items.Add(pQry_Manf_Screw_Back[i]);
                                        }
                                    }
                                    int pIndx = cmbMount_Fixture_Screw_Type_Back.Items.IndexOf("SHCS");

                                    //.....Material.
                                    var pQry_Manf_Screw_Mat_Back = (from pRec in pBearingDBEntities.tblManf_Screw where pRec.fldUnit == pUnit orderby pRec.fldType ascending select pRec.fldMat).Distinct().ToList();
                                    cmbMount_Fixture_Screw_Mat_Back.Items.Clear();
                                    if (pQry_Manf_Screw_Mat_Back.Count() > 0)
                                    {
                                        for (int i = 0; i < pQry_Manf_Screw_Mat_Back.Count; i++)
                                        {
                                            cmbMount_Fixture_Screw_Mat_Back.Items.Add(pQry_Manf_Screw_Mat_Back[i]);
                                        }
                                    }
                                    pIndx = cmbMount_Fixture_Screw_Mat_Back.Items.IndexOf("STL");

                                    if (pQry_Manf_Screw_Mat_Back.Count > 0) cmbMount_Fixture_Screw_Mat_Back.SelectedIndex = pIndx;
                                }
        ...
        //************************************     
                ...
                //============================================================
                {
                    ...
                    switch (pChkBox.Name)
                    {
                        ...
                        case "chkMillRelief_Exists":
                            ...
                            if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                            {
                                txtMillRelief_D_PadRelief.Text = modMain.ConvDoubleToStr(modMain.gProject.Unit.CEng_Met(mBearing_Radial_FP.MillRelief.D_PadRelief()), "#0.000");
                            }
                            else
                            {
            ...
            //------------------------------------  
                ...
                //=====================
                {
                    ...
                    if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                    {
                        ((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).L = modMain.gProject.Unit.CMet_Eng(modMain.ConvTextToDouble(txtL.Text));
                    }
                    else
                    {
                    ...
                    if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                    {
                        ((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).Depth_EndConfig[0] =
                                                                    modMain.gProject.Unit.CMet_Eng(modMain.ConvTextToDouble(txtDepth_EndConfig_Front.Text));
                        ((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).Depth_EndConfig[1] =
                                                                    modMain.gProject.Unit.CMet_Eng(modMain.ConvTextToDouble(txtDepth_EndConfig_Back.Text));
                    }
                    else
                    {
                        ((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).Depth_EndConfig[0] =
                    ...
                    #region "Oil Inlet:"
                        ...
                        if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                        {
                            ((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).OilInlet.Orifice_Loc_FrontFace =
                                                                            modMain.gProject.Unit.CMet_Eng(modMain.ConvTextToDouble(txtOilInlet_Orifice_Loc_FrontFace.Text));
                        }
                        else
                        {
                            ((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).OilInlet.Orifice_Loc_FrontFace =
                        ...
                        if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                        {
                            if (chkOilInlet_Annulus_Exists.Checked)
                            {
                                ...
                                ((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).OilInlet.Annulus_D =
                                                                            modMain.gProject.Unit.CMet_Eng(modMain.ConvTextToDouble(txtOilInlet_Annulus_D.Text));

                                ((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).OilInlet.Annulus_L =
                                                                            modMain.gProject.Unit.CMet_Eng( modMain.ConvTextToDouble(txtOilInlet_Annulus_L.Text));

                                ((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).OilInlet.Annulus_Loc_Back =
                                                                             modMain.gProject.Unit.CMet_Eng(modMain.ConvTextToDouble(txtOilInlet_Annulus_Loc_Back.Text));
                            }

                            if (mBearing_Radial_FP.OilInlet.Orifice_Exists_2ndSet())
                                ((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).OilInlet.Orifice_Dist_Holes =
                                                                             modMain.gProject.Unit.CMet_Eng(modMain.ConvTextToDouble(txtOilInlet_Orifice_Dist_Holes.Text));
                        }
                        else
                        {
                            if (chkOilInlet_Annulus_Exists.Checked)
                    ...
                    //-----------------
                        ...
                        for (int i = 0; i < 2; i++)
                        {
                            if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                            {
                                ((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).MillRelief.EDM_Relief[i] = modMain.gProject.Unit.CMet_Eng(modMain.ConvTextToDouble(mtxtEDM_Relief[i].Text));
                            }
                            else
                            {
                    ...
                    //-------------------------
                        ...
                        if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                        {
                            ((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).SL.LScrew_Loc_Center =
                                                                            modMain.gProject.Unit.CMet_Eng(modMain.ConvTextToDouble(txtSL_LScrew_Loc_Center.Text));

                            ((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).SL.LScrew_Loc_Front =
                                                                            modMain.gProject.Unit.CMet_Eng(modMain.ConvTextToDouble(txtSL_LScrew_Loc_Front.Text));

                            ((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).SL.RScrew_Loc_Center =
                                                                            modMain.gProject.Unit.CMet_Eng(modMain.ConvTextToDouble(txtSL_RScrew_Loc_Center.Text));

                            ((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).SL.RScrew_Loc_Front =
                                                                            modMain.gProject.Unit.CMet_Eng(modMain.ConvTextToDouble(txtSL_RScrew_Loc_Front.Text));
                        }
                        else
                        {
                            ((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).SL.LScrew_Loc_Center =
                        ...
                        if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                        {
                            ((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).SL.LDowel_Loc_Center =
                                                                            modMain.gProject.Unit.CMet_Eng(modMain.ConvTextToDouble(txtSL_LDowel_Loc_Center.Text));

                            ((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).SL.LDowel_Loc_Front =
                                                                            modMain.gProject.Unit.CMet_Eng(modMain.ConvTextToDouble(txtSL_LDowel_Loc_Front.Text));

                            ((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).SL.RDowel_Loc_Center =
                                                                            modMain.gProject.Unit.CMet_Eng(modMain.ConvTextToDouble(txtSL_RDowel_Loc_Center.Text));

                            ((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).SL.RDowel_Loc_Front =
                                                                            modMain.gProject.Unit.CMet_Eng(modMain.ConvTextToDouble(txtSL_RDowel_Loc_Front.Text));
                        }
                        else
                        {
                            ((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).SL.LDowel_Loc_Center =
                    ...
                    //------------------------- 
                        if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                        {
                            ((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).AntiRotPin.Loc_Dist_Front = modMain.gProject.Unit.CMet_Eng(modMain.ConvTextToDouble(txtAntiRotPin_Loc_Dist_Front.Text));
                        }
                        else
                        {
                        ...
                        if (mBearing_Radial_FP.AntiRotPin.Loc_Casing_SL == clsBearing_Radial_FP.clsAntiRotPin.eLoc_Casing_SL.Offset)
                        {
                            if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                            {
                                ((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).AntiRotPin.Loc_Offset =
                                                                modMain.gProject.Unit.CMet_Eng(modMain.ConvTextToDouble(txtAntiRotPin_Loc_Offset.Text));
                            }
                            else
                            {
                                ((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).AntiRotPin.Loc_Offset =
                        ...
                        if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                        {
                            ((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).AntiRotPin.Depth = modMain.gProject.Unit.CMet_Eng(modMain.ConvTextToDouble(txtAntiRotPin_Depth.Text));
                            ((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).AntiRotPin.Stickout = modMain.gProject.Unit.CMet_Eng(modMain.ConvTextToDouble(txtAntiRotPin_Stickout.Text));
                        }
                        else
                        {
                    ...
                    //  --------------
                        ...
                        if (chkMount_Holes_Bolting_Front.Checked)
                        {
                            if (!chkMount_Holes_GoThru.Checked)
                            {
                                if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                                {
                                    ((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).Mount.Holes_Thread_Depth[0] =modMain.gProject.Unit.CMet_Eng( modMain.ConvTextToDouble(txtMount_Holes_Thread_Depth_Front.Text));
                                }
                                else
                                {
                            ...
                            if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                            {
                                ((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).Mount.Fixture[0].DBC = modMain.gProject.Unit.CMet_Eng(modMain.ConvTextToDouble(txtMount_Fixture_DBC_Front.Text));
                                ((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).Mount.Fixture[0].D_Finish = modMain.gProject.Unit.CMet_Eng(modMain.ConvTextToDouble(txtMount_Fixture_D_Finish_Front.Text));
                            }
                            else
                            {
                        ...
                        if (chkMount_Holes_Bolting_Back.Checked)
                        {
                            if (!chkMount_Holes_GoThru.Checked)
                            {
                                if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                                {
                                    ((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).Mount.Holes_Thread_Depth[1] = modMain.gProject.Unit.CMet_Eng(modMain.ConvTextToDouble(txtMount_Holes_Thread_Depth_Back.Text));
                                }
                                else
                                {
                            ...
                            if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                            {
                                ((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).Mount.Fixture[1].DBC = modMain.gProject.Unit.CMet_Eng(modMain.ConvTextToDouble(txtMount_Fixture_DBC_Back.Text));
                                ((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).Mount.Fixture[1].D_Finish = modMain.gProject.Unit.CMet_Eng(modMain.ConvTextToDouble(txtMount_Fixture_D_Finish_Back.Text));
                            }
                            else
                            {
                    ...
                    switch(pCmbBox.Name)
                    {
                        ...
                        //----------------------------
                            ...
                            case "cmbSL_Screw_Spec_UnitSystem":
                                ...
                                if (pCmbBox.Text != "")
                                {
                                    mBearing_Radial_FP.SL.Screw_Spec.Unit.System = (clsUnit.eSystem)Enum.Parse(typeof(clsUnit.eSystem), pCmbBox.Text);                               
                                    Populate_SL_Details(cmbSL_Screw_Spec_Type);
                                    ...
                                    Populate_Screw_D_Desig(ref cmbMount_Fixture_Screw_D_Desig_Front,
                                                            mBearing_Radial_FP.Mount.Fixture[0].Screw_Spec.Type,
                                                            mBearing_Radial_FP.Mount.Fixture[0].Screw_Spec.Mat,
                                                            mBearing_Radial_FP.SL.Screw_Spec.Unit.System,
                                    ...
                                    Populate_Screw_D_Desig(ref cmbMount_Fixture_Screw_D_Desig_Back,
                                                            mBearing_Radial_FP.Mount.Fixture[1].Screw_Spec.Type,
                                                            mBearing_Radial_FP.Mount.Fixture[1].Screw_Spec.Mat,
                                                            mBearing_Radial_FP.SL.Screw_Spec.Unit.System,
                            ...
                            //-------------------------------                                                       
                                ...
                                if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                                {
                                    txtSL_LScrew_Loc_Center.Text = modMain.ConvDoubleToStr(modMain.gProject.Unit.CEng_Met(mBearing_Radial_FP.SL.Calc_Screw_Loc_Center()), "#0.000");
                                    txtSL_RScrew_Loc_Center.Text = modMain.ConvDoubleToStr(modMain.gProject.Unit.CEng_Met(mBearing_Radial_FP.SL.Calc_Screw_Loc_Center()), "#0.000");

                                    txtSL_Thread_Depth.Text = modMain.ConvDoubleToStr(modMain.gProject.Unit.CEng_Met(mBearing_Radial_FP.SL.Thread_Depth), "#0.000");
                                }
                                else
                                {
                            ...
                            case "cmbSL_Screw_Spec_L":  
                                ...
                                if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                                {
                                    txtSL_CBore_Depth.Text = modMain.ConvDoubleToStr(modMain.gProject.Unit.CEng_Met(mBearing_Radial_FP.SL.CBore_Depth), "#0.000");
                                }
                                else
                                {
                            ...
                            case "cmbSL_Dowel_Spec_L":
                                ...
                                if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                                {
                                    txtSL_Dowel_Depth.Text = modMain.ConvDoubleToStr(modMain.gProject.Unit.CEng_Met(mBearing_Radial_FP.SL.Dowel_Depth), "#0.000");
                                }
                                else
                                {
                        ...
                        //--------------------------
                            ...
                            //---------------------------------
                                ...
                                if (mBearing_Radial_FP.AntiRotPin.Spec.D_Desig != pPrevVal)
                                {
                                    ...
                                    if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                                    {
                                        txtAntiRotPin_Loc_Offset.Text = modMain.ConvDoubleToStr(modMain.gProject.Unit.CEng_Met(mBearing_Radial_FP.AntiRotPin.Spec.D), "#0.000"); 
                                        txtAntiRotPin_Depth.Text = modMain.gProject.Unit.CEng_Met(mBearing_Radial_FP.AntiRotPin.Depth).ToString("#0.000");
                                    }
                                    else
                                    {
                                        txtAntiRotPin_Loc_Offset.Text = modMain.ConvDoubleToStr(mBearing_Radial_FP.AntiRotPin.Spec.D, "#0.000");
                                ...
                                if (mblnAntiRotPin_Spec_D_Desig_ManuallyChanged)
                                {
                                    if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                                    {
                                        txtSL_LDowel_Loc_Center.Text = modMain.ConvDoubleToStr(modMain.gProject.Unit.CEng_Met(mBearing_Radial_FP.SL.Calc_LDowel_Loc_Center()), "#0.000");         
                                        txtSL_RDowel_Loc_Center.Text = modMain.ConvDoubleToStr(modMain.gProject.Unit.CEng_Met(mBearing_Radial_FP.SL.Calc_RDowel_Loc_Center()), "#0.000");         
                                    }
                                    else
                                    {
                            ...
                            //--------------------------
                                ...
                                if (pPrevVal_AntiRotPin_Spec_L != mBearing_Radial_FP.AntiRotPin.Spec.L)
                                {
                                    if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                                    {
                                        txtAntiRotPin_Stickout.Text = modMain.gProject.Unit.CEng_Met(mBearing_Radial_FP.AntiRotPin.Calc_Stickout()).ToString("#0.000");
                                    }
                                    else
                                    {
                            ...
                            //-------------------------------
                                if (cmbAntiRotPin_Loc_CasingSL.Text == clsBearing_Radial_FP.clsAntiRotPin.eLoc_Casing_SL.Offset.ToString())
                                {
                                    ...
                                    if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                                    {
                                        txtAntiRotPin_Loc_Offset.Text = modMain.ConvDoubleToStr(modMain.gProject.Unit.CEng_Met(mBearing_Radial_FP.AntiRotPin.Loc_Offset), "#0.000");
                                    }
                                    else
                                    {
                            ...
                            //----------------------------------
                                ...
                                if (mblnAntiRotPin_Loc_Bearing_Vert_ManuallyChanged)
                                {
                                    if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                                    {
                                        txtSL_LScrew_Loc_Front.Text = modMain.ConvDoubleToStr(modMain.gProject.Unit.CEng_Met(mBearing_Radial_FP.SL.Calc_Screw_Loc_Front("LScrew")), "#0.000");
                                        txtSL_RScrew_Loc_Front.Text = modMain.ConvDoubleToStr(modMain.gProject.Unit.CEng_Met(mBearing_Radial_FP.SL.Calc_Screw_Loc_Front("RScrew")), "#0.000");

                                        txtSL_LDowel_Loc_Center.Text = modMain.ConvDoubleToStr(modMain.gProject.Unit.CEng_Met(mBearing_Radial_FP.SL.Calc_LDowel_Loc_Center()), "#0.000");
                                        txtSL_RDowel_Loc_Center.Text = modMain.ConvDoubleToStr(modMain.gProject.Unit.CEng_Met(mBearing_Radial_FP.SL.Calc_RDowel_Loc_Center()), "#0.000");

                                        txtSL_LDowel_Loc_Front.Text = modMain.ConvDoubleToStr(modMain.gProject.Unit.CEng_Met(mBearing_Radial_FP.SL.Calc_LDowel_Loc_Front()), "#0.000");
                                        txtSL_RDowel_Loc_Front.Text = modMain.ConvDoubleToStr(modMain.gProject.Unit.CEng_Met(mBearing_Radial_FP.SL.Calc_RDowel_Loc_Front()), "#0.000");
                                    }
                                    else
                                    {
                                        txtSL_LScrew_Loc_Front.Text = modMain.ConvDoubleToStr(mBearing_Radial_FP.SL.Calc_Screw_Loc_Front("LScrew"), "#0.000");
                                        txtSL_RScrew_Loc_Front.Text = modMain.ConvDoubleToStr(mBearing_Radial_FP.SL.Calc_Screw_Loc_Front("RScrew"), "#0.000");

                                        txtSL_LDowel_Loc_Center.Text = modMain.ConvDoubleToStr(mBearing_Radial_FP.SL.Calc_LDowel_Loc_Center(), "#0.000");
                                        txtSL_RDowel_Loc_Center.Text = modMain.ConvDoubleToStr(mBearing_Radial_FP.SL.Calc_RDowel_Loc_Center(), "#0.000");

                                        txtSL_LDowel_Loc_Front.Text = modMain.ConvDoubleToStr(mBearing_Radial_FP.SL.Calc_LDowel_Loc_Front(), "#0.000");
                                        txtSL_RDowel_Loc_Front.Text = modMain.ConvDoubleToStr(mBearing_Radial_FP.SL.Calc_RDowel_Loc_Front(), "#0.000");
                                    }
                        ...
                        //-----------------------
                            ...
                            case "cmbMount_Fixture_Screw_Type_Back":
                                ...
                                Populate_Screw_D_Desig(ref cmbMount_Fixture_Screw_D_Desig_Back, mBearing_Radial_FP.Mount.Fixture[1].Screw_Spec.Type,
                                                            cmbMount_Fixture_Screw_Mat_Back.Text, mBearing_Radial_FP.SL.Screw_Spec.Unit.System, 
                                                            mBearing_Radial_FP.Mount.Fixture[1].Screw_Spec.D_Desig);
                                Populate_Screw_Mat(ref cmbMount_Fixture_Screw_Mat_Back, pCmbBox.Text, mBearing_Radial_FP.Unit.System);
                                break;
                            ...
                            //------------------------------------------
                                ...
                                mBearing_Radial_FP.Mount.Fixture[0].Screw_Spec.GetPitch(pCmbBox.Text, out Pitch_Array, out PitchType_Array, cmbSL_Screw_Spec_UnitSystem.Text);  //AES 13AUG18
                            ...
                            case "cmbMount_Fixture_Screw_D_Desig_Back":
                                //-------------------------------------
                                //....Populate Pitch Array & Pitch Type.                                   
                                mBearing_Radial_FP.Mount.Fixture[1].Screw_Spec.GetPitch(pCmbBox.Text, out Pitch_Array, out PitchType_Array, cmbSL_Screw_Spec_UnitSystem.Text); //AES 13AUG18
                ...
                //==========================================================            
                {
                    ...
                    switch(pTxtBox.Name)
                    {
                        ...
                        //----------
                            if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                            {
                                mBearing_Radial_FP.L =modMain.gProject.Unit.CMet_Eng( modMain.ConvTextToDouble(txtL.Text));
                                ...
                                if (mblnL_ManuallyChanged)
                                {
                                    ...
                                    //....End-Configs Depth:
                                    //
                                    double pDepth =modMain.gProject.Unit.CEng_Met( mBearing_Radial_FP.Calc_Depth_EndConfig());      //....Symmetrical Depths.
                                    ...
                                    mBearing_Radial_FP.Depth_EndConfig[0] = modMain.gProject.Unit.CMet_Eng(pDepth);
                                    ...
                                    mBearing_Radial_FP.Depth_EndConfig[1] = modMain.gProject.Unit.CMet_Eng(pDepth);


                                    //....Oil Inlet:
                                    //
                                    //....Orifice.
                                    double pLoc = modMain.gProject.Unit.CEng_Met(mBearing_Radial_FP.OilInlet.Calc_Orifice_Loc_FrontFace());
                                    txtOilInlet_Orifice_Loc_FrontFace.Text = modMain.ConvDoubleToStr(pLoc, "#0.000");


                                    //....Annulus.
                                    txtOilInlet_Annulus_Loc_Back.Text = modMain.ConvDoubleToStr(modMain.gProject.Unit.CEng_Met(mBearing_Radial_FP.OilInlet.Calc_Annulus_Loc_Back()), "#0.000");     
                        ...
                        //------------------
                            ...
                            if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                            {
                                mBearing_Radial_FP.OilInlet.Orifice_Loc_FrontFace = modMain.gProject.Unit.CMet_Eng(modMain.ConvTextToDouble(txtOilInlet_Orifice_Loc_FrontFace.Text));
                            }
                            else
                            {
                            ...
                            //---------------------------
                             if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                             {
                                 mBearing_Radial_FP.OilInlet.Annulus_D = modMain.gProject.Unit.CMet_Eng(modMain.ConvTextToDouble(txtOilInlet_Annulus_D.Text));
                                 ...
                                 {
                                     txtOilInlet_Annulus_L.Text = modMain.gProject.Unit.CEng_Met(mBearing_Radial_FP.OilInlet.Calc_Annulus_L(modMain.gProject.Unit.CMet_Eng(modMain.ConvTextToDouble(txtOilInlet_Annulus_D.Text)))).ToString("#0.000");
                            ...
                            //---------------------------
                                if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                                {
                                    mBearing_Radial_FP.OilInlet.Annulus_L = modMain.gProject.Unit.CMet_Eng(modMain.ConvTextToDouble(txtOilInlet_Annulus_L.Text));
                                    txtOilInlet_Annulus_V.Text = modMain.ConvDoubleToStr(mBearing_Radial_FP.OilInlet.Annulus_V(modMain.ConvTextToDouble(txtOilInlet_Annulus_D.Text),
                                                                                         modMain.ConvTextToDouble(txtOilInlet_Annulus_L.Text)), "#0.000");
                                    ...
                                    if (mblnOilInlet_Annulus_L_ManuallyChanged)
                                    {
                                        Double pRatio_L_H = mBearing_Radial_FP.OilInlet.Calc_Annulus_Ratio_L_H
                                                           (modMain.gProject.Unit.CMet_Eng(modMain.ConvTextToDouble(txtOilInlet_Annulus_D.Text)), modMain.gProject.Unit.CMet_Eng(modMain.ConvTextToDouble(txtOilInlet_Annulus_L.Text)));
                        ...
                        case "txtOilInlet_Annulus_Loc_Back":
                            //------------------------------
                                if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                                {
                                    mBearing_Radial_FP.OilInlet.Annulus_Loc_Back = modMain.gProject.Unit.CMet_Eng(modMain.ConvTextToDouble(txtOilInlet_Annulus_Loc_Back.Text));     
                        ...
                        //------------------
                            ...
                            if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                            {
                                mBearing_Radial_FP.MillRelief.EDM_Relief[0] =modMain.gProject.Unit.CMet_Eng( modMain.ConvTextToDouble(pTxtBox.Text));
                                ...
                                if (mblnEDM_Relief_Front_ManuallyChanged)
                                {
                                    ...
                                    txtOilInlet_Orifice_Loc_FrontFace.Text = modMain.ConvDoubleToStr(modMain.gProject.Unit.CEng_Met(mBearing_Radial_FP.OilInlet.Calc_Orifice_Loc_FrontFace()), "#0.000#");
                            ...
                            case "txtEDMRelief_Back":
                                ...
                                if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                                {
                                    mBearing_Radial_FP.MillRelief.EDM_Relief[1] =modMain.gProject.Unit.CMet_Eng( modMain.ConvTextToDouble(pTxtBox.Text));
                        ...
                        //------------------------
                            ...
                            case "txtAntiRotPin_Loc_Dist_Front":
                                ...
                                if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                                {
                                    mBearing_Radial_FP.AntiRotPin.Loc_Dist_Front = modMain.gProject.Unit.CMet_Eng(modMain.ConvTextToDouble(txtAntiRotPin_Loc_Dist_Front.Text));

                                    if (mblnAntiRotPin_Loc_Dist_Front_ManuallyChanged)
                                    {
                                        txtSL_LScrew_Loc_Front.Text = modMain.ConvDoubleToStr(modMain.gProject.Unit.CEng_Met(mBearing_Radial_FP.SL.Calc_Screw_Loc_Front("LScrew")), "#0.000");    //BG 26NOV12
                                        txtSL_RScrew_Loc_Front.Text = modMain.ConvDoubleToStr(modMain.gProject.Unit.CEng_Met(mBearing_Radial_FP.SL.Calc_Screw_Loc_Front("RScrew")), "#0.000");    //BG 26NOV12

                                        txtSL_LDowel_Loc_Front.Text = modMain.ConvDoubleToStr(modMain.gProject.Unit.CEng_Met(mBearing_Radial_FP.SL.Calc_LDowel_Loc_Front()), "#0.000");    //BG 26NOV12
                                        txtSL_RDowel_Loc_Front.Text = modMain.ConvDoubleToStr(modMain.gProject.Unit.CEng_Met(mBearing_Radial_FP.SL.Calc_RDowel_Loc_Front()), "#0.000");    //BG 26NOV12
                            ...
                            case "txtAntiRotPin_Loc_Offset":
                                ...
                                if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                                {
                                    mBearing_Radial_FP.AntiRotPin.Loc_Offset = modMain.gProject.Unit.CMet_Eng(modMain.ConvTextToDouble(txtAntiRotPin_Loc_Offset.Text));
                                }
                                else
                                {
                            ...
                            case "txtAntiRotPin_Depth":
                                ...
                                if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                                {
                                    mBearing_Radial_FP.AntiRotPin.Depth = modMain.gProject.Unit.CMet_Eng(modMain.ConvTextToDouble(txtAntiRotPin_Depth.Text));
                                    ...
                                    {
                                        txtAntiRotPin_Stickout.Text = modMain.gProject.Unit.CEng_Met(mBearing_Radial_FP.AntiRotPin.Stickout).ToString("#0.000");
                            ...
                            case "txtAntiRotPin_Stickout":
                                ...
                                if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                                {
                                    mBearing_Radial_FP.AntiRotPin.Stickout = modMain.gProject.Unit.CMet_Eng(modMain.ConvTextToDouble(txtAntiRotPin_Stickout.Text));
                        ...
                        //----------------------  
                            ...
                            case "txtMount_Fixture_DBC_Front":
                                ...
                                if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                                {
                                    mBearing_Radial_FP.Mount.Fixture[0].DBC =
                                        modMain.gProject.Unit.CMet_Eng(modMain.ConvTextToDouble(txtMount_Fixture_DBC_Front.Text));
                                }
                                else
                                {
                                    mBearing_Radial_FP.Mount.Fixture[0].DBC =
                            ...
                            case "txtMount_Fixture_DBC_Back":
                                ...
                                if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                                {
                                    mBearing_Radial_FP.Mount.Fixture[1].DBC =
                                         modMain.gProject.Unit.CMet_Eng(modMain.ConvTextToDouble(txtMount_Fixture_DBC_Back.Text));
                                }
                                else
                                {
                                    mBearing_Radial_FP.Mount.Fixture[1].DBC =
                            ...
                            case "txtMount_Fixture_D_Finish_Front":
                                ...
                                if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                                {
                                    mBearing_Radial_FP.Mount.Fixture[0].D_Finish = modMain.gProject.Unit.CMet_Eng(modMain.ConvTextToDouble(txtMount_Fixture_D_Finish_Front.Text));
                                    txtMount_Fixture_WallT_Back.Text = modMain.ConvDoubleToStr(modMain.gProject.Unit.CEng_Met((Double)mBearing_Radial_FP.Mount.TWall_BearingCB(0)), "#0.000");

                                    SetMountFixture(mBearing_Radial_FP);
                                    txtRoughing_Loc_Fixture_B.Text = modMain.gProject.Unit.CEng_Met(mBearing_Radial_FP.Loc_Fixture_B()).ToString("0.000");
                                }
                                else
                                {
                            ...
                            case "txtMount_Fixture_D_Finish_Back":
                                ...
                                if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                                {
                                    mBearing_Radial_FP.Mount.Fixture[1].D_Finish = modMain.gProject.Unit.CMet_Eng(modMain.ConvTextToDouble(txtMount_Fixture_D_Finish_Front.Text));
                                    txtMount_Fixture_WallT_Back.Text = modMain.ConvDoubleToStr(modMain.gProject.Unit.CEng_Met((Double)mBearing_Radial_FP.Mount.TWall_BearingCB(1)), "#0.000");
                                ...
                                {
                                    mBearing_Radial_FP.Mount.Fixture[1].D_Finish = modMain.ConvTextToDouble(txtMount_Fixture_D_Finish_Front.Text);
                    ...
                    switch (pTxtBox.Name)
                    {
                        case "txtDepth_EndConfig_Front":
                            ...
                            if (mblnDepth_EndConfig_F_ManuallyChanged && txtDepth_EndConfig_Front.Text != "")
                            {
                                if (!mblnDepth_EndConfig_B_ManuallyChanged)
                                {
                                    ...
                                    {
                                        //....Retrieve from Text Box.
                                        pDepthF = modMain.gProject.Unit.CMet_Eng(modMain.ConvTextToDouble(txtDepth_EndConfig_Front.Text));
                                    }
                                    else
                                    {
                                        //....Retrieve from Text Box.
                        ...
                        case "txtDepth_EndConfig_Back":
                            ...
                            if (mblnDepth_EndConfig_B_ManuallyChanged && txtDepth_EndConfig_Back.Text != "")
                            {
                                if (!mblnDepth_EndConfig_F_ManuallyChanged)
                                {
                                    ...
                                    if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                                    {
                                         pDepthB = modMain.gProject.Unit.CEng_Met(modMain.ConvTextToDouble(txtDepth_EndConfig_Back.Text));
                                    }
                                    else
                                    {
                        ...
                        case "txtMount_Holes_Thread_Depth_Front":
                            ...
                            if (!mBearing_Radial_FP.Mount.Holes_GoThru)
                            {
                                if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                                {
                                    pVal = modMain.gProject.Unit.CMet_Eng(modMain.ConvTextToDouble(txtMount_Holes_Thread_Depth_Front.Text));

                                    if (mblnMount_Holes_Thread_Depth_ManuallyChanged)
                                    {
                                        mblnMount_Holes_Thread_Depth_ManuallyChanged = false;
                                        txtMount_Holes_Thread_Depth_Front.Text =
                                            modMain.gProject.Unit.CEng_Met(mBearing_Radial_FP.Mount.Validate_Holes_Thread_Depth(0, pVal)).ToString("#0.00#");
                                        pVal = modMain.gProject.Unit.CMet_Eng(modMain.ConvTextToDouble(txtMount_Holes_Thread_Depth_Front.Text));
                                        e.Cancel = true;
                                    }
                                }
                        ...
                        case "txtMount_Holes_Thread_Depth_Back":
                            ...
                            if (!mBearing_Radial_FP.Mount.Holes_GoThru)
                            {
                                if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                                {
                                    pVal = modMain.gProject.Unit.CMet_Eng(modMain.ConvTextToDouble(txtMount_Holes_Thread_Depth_Back.Text));

                                    if (mblnMount_Holes_Thread_Depth_ManuallyChanged)
                                    {
                                        mblnMount_Holes_Thread_Depth_ManuallyChanged = false;
                                        txtMount_Holes_Thread_Depth_Back.Text =
                                            modMain.gProject.Unit.CEng_Met(mBearing_Radial_FP.Mount.Validate_Holes_Thread_Depth(1, pVal)).ToString("#0.00#");
                                        pVal = modMain.gProject.Unit.CMet_Eng(modMain.ConvTextToDouble(txtMount_Holes_Thread_Depth_Back.Text));
                                        e.Cancel = true;
                                    }
                                }
                   ...
                   //=======================================
                    ...
                    //===================================================================
                    {
                        ...
                        if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                        {
                            ...
                            Double pDepth_Other = pDepth_Tot -modMain.gProject.Unit.CMet_Eng( modMain.ConvTextToDouble(Txt_In.Text));
                            Txt_Out.Text = modMain.gProject.Unit.CEng_Met(pDepth_Other).ToString("#0.000");
        ...
        //************************
            ...
            #region "OIL INLET."
                ...
                //============================================ 
                {
                    if (mBearing_Radial_FP.OilInlet.Count_MainOilSupply != 0)
                    {
                        if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                        {
                            Double pRatio_LH = mBearing_Radial_FP.OilInlet.Calc_Annulus_Ratio_L_H(modMain.gProject.Unit.CMet_Eng(modMain.ConvTextToDouble(txtOilInlet_Annulus_D.Text)), 
                                                                                                 modMain.gProject.Unit.CMet_Eng(modMain.ConvTextToDouble(txtOilInlet_Annulus_L.Text)));      
                            ...
                            txtOilInlet_Annulus_D.Text = modMain.ConvDoubleToStr(modMain.gProject.Unit.CEng_Met(mBearing_Radial_FP.OilInlet.Annulus.D), modMain.gUnit.MFormat);
                            if (!mblnOilInlet_Annulus_D_ManuallyChanged) txtOilInlet_Annulus_D.ForeColor = Color.Blue;

                            txtOilInlet_Annulus_L.Text = modMain.ConvDoubleToStr(modMain.gProject.Unit.CEng_Met(mBearing_Radial_FP.OilInlet.Annulus.L), modMain.gUnit.MFormat);
            ...
            #region "SPLIT LINE HARDWARE:"
                ...
                //================================
                {
                    ...
                    {
                        var pQryManfScrew_LenLim = (from pRec in pBearingDBEntities.tblManf_Screw
                                                    where pRec.fldUnit == pSL_Screw_Unit && pRec.fldType == pSL_Screw_Type &&
                                                    pRec.fldD_Desig == pSL_Screw_D && pRec.fldMat == pSL_Screw_Mat
                                                    && pRec.fldL > (Decimal)mBearing_Radial_FP.SL.Thread_L_LowerLimit()
                                                    orderby pRec.fldL ascending
                                                    select pRec.fldL).Distinct().ToList();

                        if (pQryManfScrew_LenLim.Count() > 0)
                        {
                            for (int i = 0; i < pQryManfScrew_LenLim.Count; i++)
                            {
                                pScrew_L.Add(pQryManfScrew_LenLim[i].ToString());
                            }
                        }
                    }
                    else
                    {
                        var pQryManfScrew = (from pRec in pBearingDBEntities.tblManf_Screw
                                             where pRec.fldUnit == pSL_Screw_Unit && pRec.fldType == pSL_Screw_Type &&
                                             pRec.fldD_Desig == pSL_Screw_D && pRec.fldMat == pSL_Screw_Mat
                                             orderby pRec.fldL ascending
                                             select pRec.fldL).Distinct().ToList();

                        if (pQryManfScrew.Count() > 0)
                        {
                            for (int i = 0; i < pQryManfScrew.Count; i++)
                            {
                                pScrew_L.Add(pQryManfScrew[i].ToString());
                            }
                        }
                    }
                ...
                //============================================================
                {
                    ...
                    {
                        var pQryManfScrew_LenLim = (from pRec in pBearingDBEntities.tblManf_Screw
                                                    where pRec.fldUnit == pSL_Screw_Unit && pRec.fldType == pSpLineHard_Thread_Type &&
                                                    pRec.fldD_Desig == pSpLineHard_Thread_D && pRec.fldMat == pSpLineHard_Thread_Mat
                                                    && pRec.fldL > (Decimal)mBearing_Radial_FP.SL.Thread_L_LowerLimit()
                                                    orderby pRec.fldL ascending
                                                    select pRec.fldL).Distinct().ToList();
                        ...
                        if (pQryManfScrew_LenLim.Count() > 0)
                        {
                            for (int i = 0; i < pQryManfScrew_LenLim.Count; i++)
                            {
                                pThread_L.Add(pQryManfScrew_LenLim[i].ToString());
                            }
                        }
            ...
            #region "END CONFIGS MOUNT FIXTURE:"
                ...
                #region "THREAD RELATED ROUTINES:"
                    ...
                    //============================================================================================================
                    {
                        ...
                        string pThreadType = "'" + Thread_Type_In + "'";
                        string pD_Desig = "'" + Thread_D_Desig + "'";
                        string pUnit = "'" + pUnitSystem + "'";
                        BearingDBEntities pBearingDBEntities = new BearingDBEntities();
                        var pQry_Manf_Screw = (from pRec in pBearingDBEntities.tblManf_Screw
                                               where pRec.fldType == pThreadType &&
                                                   pRec.fldD_Desig == pD_Desig && pRec.fldUnit == pUnit
                                               orderby pRec.fldType
                                                   ascending
                                               select pRec.fldMat).ToList();
                    ...
                    //==================================================================
                    {
                        ...
                        BearingDBEntities pBearingDBEntities = new BearingDBEntities();
                        Decimal pThread_L_ULimit = 0.0m;
                        Decimal pThread_L_LLimit = 0.0m;
                        ...
                        if (MountHole_Pos_In == 0)
                        {
                            ...
                            if (chkMount_Fixture_Screw_LenLim_Front.Checked)
                            {
                                ...
                                pThread_L_ULimit = Convert.ToDecimal(pThread_L_UpperLimit);
                                pThread_L_LLimit = Convert.ToDecimal(pThread_L_LowerLimit);

                                var pQry_Manf_Screw = (from pRec in pBearingDBEntities.tblManf_Screw
                                                       where pRec.fldType == pThread_Type && pRec.fldD_Desig == pThread_D &&
                                                       pRec.fldMat == pThread_Mat && pRec.fldL <= pThread_L_ULimit &&
                                                       pRec.fldL >= pThread_L_LLimit
                                                       orderby pRec.fldL ascending
                                                       select pRec.fldL).Distinct().ToList();

                                pSealMountFixture_Sel_Thread_L.Clear();
                                if (pQry_Manf_Screw.Count() > 0)
                                {
                                    for (int i = 0; i < pQry_Manf_Screw.Count; i++)
                                    {
                                        pSealMountFixture_Sel_Thread_L.Add(pQry_Manf_Screw[i].ToString());
                                    }
                                }
                            ...
                            {
                                var pQry_Manf_Screw = (from pRec in pBearingDBEntities.tblManf_Screw
                                                       where pRec.fldType == pThread_Type &&
                                                       pRec.fldD_Desig == pThread_D && pRec.fldMat == pThread_Mat
                                                       orderby pRec.fldType ascending
                                                       select pRec.fldL).Distinct().ToList();
                        ...
                        else if (MountHole_Pos_In == 1)
                        {
                            ...
                            if (chkMount_Fixture_Screw_LenLim_Back.Checked)
                            {
                                ...
                                pThread_L_LLimit = Convert.ToDecimal(pThread_L_LowerLimit);
                                var pQry_Manf_Screw = (from pRec in pBearingDBEntities.tblManf_Screw
                                                       where pRec.fldType == pThread_Type && pRec.fldD_Desig == pThread_D && pRec.fldMat == pThread_Mat &&
                                                       pRec.fldL <= pThread_L_ULimit && pRec.fldL >= pThread_L_LLimit
                                                       orderby pRec.fldL ascending
                                                       select pRec.fldL).Distinct().ToList();
                ...
                #region "UPDATE FIXTURE:"
                    ...
                    private void Upadate_Fixture_Selection(clsBearing_Radial_FP Bearing_In)
                    //============================================================================================      
                    {
                    ...
                    //======================================================================
                    {
                        ...
                        switch (MountHolePos_In)
                        {
                            case 0:
                                ...
                                var pQry_Manf_Screw_Front = (from pRec in pBearingDBEntities.tblManf_Screw
                                                             where pRec.fldUnit == pUnit
                                                             orderby pRec.fldType ascending
                                ...
                                if (pQry_Manf_Screw_Mat_Front.Count() > 0)
                                {
                                    for (int j = 0; j < pQry_Manf_Screw_Mat_Front.Count; j++)
                                    {
                                        cmbMount_Fixture_Screw_Mat_Front.Items.Add(pQry_Manf_Screw_Mat_Front[j]);
                                    }
                                }
                            ...
                            case 1:
                                ...
                                //  =======
                                //.....Populate ComboBox SplitLine DowelPin Type.
                                var pQry_Manf_Screw_Back = (from pRec in pBearingDBEntities.tblManf_Screw
                                                            where pRec.fldUnit == pUnit
                                                            orderby pRec.fldType ascending
                                                            select pRec.fldType).Distinct().ToList();
                                ...
                                var pQry_Manf_Screw_Mat_Back = (from pRec in pBearingDBEntities.tblManf_Screw
                                                                where pRec.fldUnit == pUnit
                                                                orderby pRec.fldMat ascending
                                                                select pRec.fldMat).Distinct().ToList();
                    ...
                    private void Display_Candidate_Fixture_Details(clsBearing_Radial_FP Bearing_In, Int32 MountHole_Pos_In)
                    //======================================================================================================
                    {
                        BearingDBEntities pBearingDBEntities = new BearingDBEntities();   
                        ...
                        switch (MountHole_Pos_In)
                        {
                            case 0:
                                ...
                                if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                                {
                                    txtMount_Fixture_DBC_Front.Text = modMain.gProject.Unit.WriteInUserL(modMain.gProject.Unit.CEng_Met(Bearing_In.Mount.Fixture[MountHole_Pos_In].DBC));
                                    txtMount_Fixture_DBC_Front.ForeColor = Color.Magenta;
                                    txtMount_Fixture_D_Finish_Front.Text = modMain.gProject.Unit.WriteInUserL(modMain.gProject.Unit.CEng_Met(Bearing_In.Mount.Fixture[MountHole_Pos_In].D_Finish));
                                    txtMount_Fixture_D_Finish_Front.ForeColor = Color.Magenta;
                                    txtMount_Fixture_WallT_Front.Text = modMain.gProject.Unit.WriteInUserL(modMain.gProject.Unit.CEng_Met(Bearing_In.Mount.TWall_BearingCB(MountHole_Pos_In)));
                                ...
                                {
                                    txtMount_Fixture_DBC_Front.Text = modMain.gProject.Unit.WriteInUserL(Bearing_In.Mount.Fixture[MountHole_Pos_In].DBC);
                                    txtMount_Fixture_DBC_Front.ForeColor = Color.Magenta;
                                    txtMount_Fixture_D_Finish_Front.Text = modMain.gProject.Unit.WriteInUserL(Bearing_In.Mount.Fixture[MountHole_Pos_In].D_Finish);
                                    txtMount_Fixture_D_Finish_Front.ForeColor = Color.Magenta;
                                    txtMount_Fixture_WallT_Front.Text = modMain.gProject.Unit.WriteInUserL(Bearing_In.Mount.TWall_BearingCB(MountHole_Pos_In));
                                    txtMount_Fixture_HolesCount_Front.Text = modMain.ConvIntToStr(Bearing_In.Mount.Fixture[MountHole_Pos_In].HolesCount);
                                    txtMount_Fixture_HolesCount_Front.ForeColor = Color.Magenta;
                                }
                               ...
                               pD_Desig = Bearing_In.Mount.Fixture[0].Screw_Spec.D_Desig;
                                    var pQry_Manf_Screw_Type_Front = (from pRec in pBearingDBEntities.tblManf_Screw where
                                                                      pRec.fldD_Desig == pD_Desig
                                                                      orderby pRec.fldType ascending select pRec.fldType).Distinct().ToList();
                                    cmbMount_Fixture_Screw_Type_Front.Items.Clear();
                                    if (pQry_Manf_Screw_Type_Front.Count() > 0)
                                    {
                                        for (int i = 0; i < pQry_Manf_Screw_Type_Front.Count; i++)
                                        {
                                            cmbMount_Fixture_Screw_Type_Front.Items.Add(pQry_Manf_Screw_Type_Front[i]);
                                        }
                                    }
                                    ...
                                    pD_Desig = Bearing_In.Mount.Fixture[0].Screw_Spec.D_Desig;
                                    pScrew_Spec_Type = Bearing_In.Mount.Fixture[0].Screw_Spec.Type;
                                    var pQry_Manf_Screw_Mat_Front = (from pRec in pBearingDBEntities.tblManf_Screw
                                                                     where pRec.fldD_Desig == pD_Desig &&
                                                                     pRec.fldType == pScrew_Spec_Type
                                                                     orderby pRec.fldMat ascending select pRec.fldMat).Distinct().ToList();
                                ...
                                mBearing_Radial_FP.Mount.Fixture[0].Screw_Spec.GetPitch(Bearing_In.Mount.Fixture[0].Screw_Spec.D_Desig, out pPitch_Array_Front, out pPitchType_Array_Front);
                                ...
                                cmbMount_Fixture_Screw_L_Front.Text = modMain.gProject.Unit.WriteInUserL(Bearing_In.Mount.Fixture[0].Screw_Spec.L);
                            ...
                            case 1:
                                ...
                                if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                                {
                                    txtMount_Fixture_DBC_Back.Text = modMain.gProject.Unit.WriteInUserL(modMain.gProject.Unit.CEng_Met(Bearing_In.Mount.Fixture[MountHole_Pos_In].DBC));
                                    txtMount_Fixture_DBC_Back.ForeColor = Color.Magenta;
                                    txtMount_Fixture_D_Finish_Back.Text = modMain.gProject.Unit.WriteInUserL(modMain.gProject.Unit.CEng_Met(Bearing_In.Mount.Fixture[MountHole_Pos_In].D_Finish));
                                    txtMount_Fixture_D_Finish_Back.ForeColor = Color.Magenta;
                                    txtMount_Fixture_WallT_Back.Text = modMain.gProject.Unit.WriteInUserL(modMain.gProject.Unit.CEng_Met(Bearing_In.Mount.TWall_BearingCB(MountHole_Pos_In)));
                                ...
                                {
                                    txtMount_Fixture_DBC_Back.Text = modMain.gProject.Unit.WriteInUserL(Bearing_In.Mount.Fixture[MountHole_Pos_In].DBC);
                                    txtMount_Fixture_DBC_Back.ForeColor = Color.Magenta;
                                    txtMount_Fixture_D_Finish_Back.Text = modMain.gProject.Unit.WriteInUserL(Bearing_In.Mount.Fixture[MountHole_Pos_In].D_Finish);
                                    txtMount_Fixture_D_Finish_Back.ForeColor = Color.Magenta;
                                    txtMount_Fixture_WallT_Back.Text = modMain.gProject.Unit.WriteInUserL(Bearing_In.Mount.TWall_BearingCB(MountHole_Pos_In));
                                    txtMount_Fixture_HolesCount_Back.Text = modMain.ConvIntToStr(Bearing_In.Mount.Fixture[MountHole_Pos_In].HolesCount);
                                    txtMount_Fixture_HolesCount_Back.ForeColor = Color.Magenta;
                                }
                                ...
                                //....Thread.   
                                pD_Desig = Bearing_In.Mount.Fixture[1].Screw_Spec.D_Desig;
                                ////txtMount_Fixture_Screw_D_Desig_Back.Text = Bearing_In.Mount.Fixture[1].Screw_Spec.D_Desig;
                               var pQry_Manf_Screw_Type_Back = (from pRec in pBearingDBEntities.tblManf_Screw where
                                                                  pRec.fldD_Desig == pD_Desig 
                                                                  orderby pRec.fldType ascending select pRec.fldType).Distinct().ToList();

                                 cmbMount_Fixture_Screw_Type_Back.Items.Clear();

                                if (pQry_Manf_Screw_Type_Back.Count() > 0)
                                {
                                    for (int i = 0; i < pQry_Manf_Screw_Type_Back.Count; i++)
                                    {
                                        cmbMount_Fixture_Screw_Type_Back.Items.Add(pQry_Manf_Screw_Type_Back[i]);
                                    }
                                }
                                ...
                                pD_Desig = Bearing_In.Mount.Fixture[1].Screw_Spec.D_Desig;
                                pScrew_Spec_Type = Bearing_In.Mount.Fixture[1].Screw_Spec.Type;
                                 var pQry_Manf_Screw_Mat_Back = (from pRec in pBearingDBEntities.tblManf_Screw where
                                                                 pRec.fldD_Desig == pD_Desig &&
                                                                 pRec.fldType == pScrew_Spec_Type
                                                                 orderby pRec.fldMat ascending select pRec.fldMat).Distinct().ToList();
                                ...
                                mBearing_Radial_FP.Mount.Fixture[1].Screw_Spec.GetPitch(Bearing_In.Mount.Fixture[1].Screw_Spec.D_Desig, out pPitch_Array_Back, out pPitchType_Array_Back);
                                ...
                                cmbMount_Fixture_Screw_L_Back.Text = modMain.gProject.Unit.WriteInUserL(Bearing_In.Mount.Fixture[1].Screw_Spec.L);
                    ...
                    //================================================================================================
                    {
                        switch (MountHole_Pos_In)
                        {
                            case "Front":
                                ...
                                {
                                    //....Wall thick
                                    txtMount_Fixture_WallT_Front.Text = modMain.gProject.Unit.WriteInUserL(modMain.gProject.Unit.CEng_Met((Double)Bearing_In.Mount.TWall_BearingCB(0)));
                                }
                                else
                                {
                                    //....Wall thick
                                    txtMount_Fixture_WallT_Front.Text = modMain.gProject.Unit.WriteInUserL((Double)Bearing_In.Mount.TWall_BearingCB(0));
                                }
                            ...
                            case "Back":
                                ...
                                {
                                    //....Wall thick
                                    txtMount_Fixture_WallT_Back.Text = modMain.gProject.Unit.WriteInUserL(modMain.gProject.Unit.CEng_Met((Double)Bearing_In.Mount.TWall_BearingCB(1)));
                                }
                                else
                                {
                                    //....Wall thick
                                    txtMount_Fixture_WallT_Back.Text = modMain.gProject.Unit.WriteInUserL((Double)Bearing_In.Mount.TWall_BearingCB(1));
                                }
                            ...
                            case 0:
                                ...
                                if (!Bearing_In.Mount.Fixture[0].HolesEquiSpaced)
                                {
                                    for (int i = 0; i < Bearing_In.Mount.Fixture[0].HolesCount - 1; i++)
                                    {
                                        ...
                                        ////else
                                        ////{
                                        mTxtMount_Fixture_HolesAngOther_Front[i].ReadOnly = false;
                                            mTxtMount_Fixture_HolesAngOther_Front[i].BackColor = Color.White;
                            ...
                            case 1:
                                ...
                                if (!Bearing_In.Mount.Fixture[1].HolesEquiSpaced)
                                {
                                    for (int i = 0; i < Bearing_In.Mount.Fixture[1].HolesCount - 1; i++)
                                    {
                                        ...
                                        ////else
                                        ////{
                                        mTxtMount_Fixture_HolesAngOther_Back[i].ReadOnly = false;
                                            mTxtMount_Fixture_HolesAngOther_Back[i].BackColor = Color.White;
                ...
                //===============================================================================================
                {
                    ...
                    if (pUnitSystem == "E")
                    {
                        ...
                        var pQry_Manf_Pin = (from pRec in pBearingDBEntities.tblManf_Pin
                                             where pRec.fldType == pPin_Type && pRec.fldUnit == pUnitSystem &&
        ...
        #region "VALIDATION ROUTINES:"
            ...
            //=======================================
            {
                Double pOilInlet_Annulus_D = 0.0F;
                if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                {
                    pOilInlet_Annulus_D = modMain.gProject.Unit.CMet_Eng(modMain.ConvTextToDouble(txtOilInlet_Annulus_D.Text));
                }
                else
                {
                ...
                else
                {
                    ...
                    if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                    {
                        pMSg = " Please enter value Less than : " + modMain.ConvDoubleToStr(modMain.gProject.Unit.CEng_Met(pTempBearing.OilInlet.Annulus.D), modMain.gUnit.MFormat);
                    }
                    else
                    {
                        pMSg = " Please enter value Less than : " + modMain.ConvDoubleToStr(pTempBearing.OilInlet.Annulus.D, modMain.gUnit.MFormat); 
                    }
            ...
            //=======================================
            {
                ...
                if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                {                    
                    pOilInlet_Annulus_L = modMain.gProject.Unit.CMet_Eng(modMain.ConvTextToDouble(txtOilInlet_Annulus_L.Text));
                }
                else
                {
            ...
            private void grpMount_Fixture_Front_Paint(object sender, PaintEventArgs e)
            //========================================================================
            {
                Graphics gfx = e.Graphics;
                Pen p = new Pen(Color.White, 1);
            ...
            private void grpMount_Fixture_Back_Paint(object sender, PaintEventArgs e)
            //========================================================================
            {
                Graphics gfx = e.Graphics;
                Pen p = new Pen(Color.White, 1);
