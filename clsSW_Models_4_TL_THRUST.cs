...
//                                                                              '
//                          SOFTWARE  :  "BearingCAD"                           '
//                      CLASS MODULE  :  clsSW_Models_4_TL_THRUST               '
//                        VERSION NO  :  2.0                                    '
...
namespace BearingCAD20
{
    partial class clsSW_Models
    {
                        ...
                        if (pSoftware_VarName[i] != "")
                        {
                            switch (pSoftware_VarName[i])
                            {
                                ...
                                case "gProject.Product.EndConfig[i].FeedGroove.Type":               //Col. AS
                                    ...
                                    if (Project_In.Product.EndConfig[0].Type == clsEndConfig.eType.Thrust_Bearing_TL)
                                    {
                                        if (mEndTB[0].FeedGroove.Type.ToString() != "")
                                        {
                                    ...
                                    if (Project_In.Product.EndConfig[1].Type == clsEndConfig.eType.Thrust_Bearing_TL)
                                    {
                                        if (mEndTB[1].FeedGroove.Type.ToString() != "")
                                        {
        ...
        #region "EXCEL MAPPING:"
            ...
            private void PopulateAndMove_DT_TL_TB(clsFiles Files_In, clsProject Project_In,
            ...
            //===========================================================================    
            {
                try
                {
                    ...
                    string pFile = modMain.ExtractPreData(mcTL_TB_Title, ".");
