...
//                                                                              '
//                          SOFTWARE  :  "BearingCAD"                           '
//                      CLASS MODULE  :  clsDesignTables_2_BLANK_ASSY           '
//                        VERSION NO  :  2.0                                    '
...
namespace BearingCAD20
{
    partial class clsDesignTables
    {
        ...
        private const string mcBlankAssy_Title = "BLANK";
         ...
         #region "EXCEL MAPPING:"
             ...
             private void Populate_EXCEL_BlankAssy(clsFiles Files_In, clsProject Project_In,
             ...
             //============================================================================
             {
                 try
                 {
                     ...
                     String pFileName = FileName_In + "\\" + mcBlankAssy_Title + ".xlsx";
