            ...
            //-----------------------
                ...
                //=====================================================================    AES 04JUL18                                     
                {
                    ...
                    else if (pUnitSystem == "M")
                    {
                        //....Populate Dia Desig.
                        StringCollection pDia_Desig = new StringCollection();
                        var pQryManf_Screw = (from pRec in pBearingDBEntities.tblManf_Screw where pRec.fldUnit == pUnitSystem select pRec.fldD_Desig).ToList();
                        ...
                        else
                        {
                            if (((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).Mount.Holes_Bolting == clsBearing_Radial_FP.eFaceID.Both)
                            {
                                if (modMain.gProject.Product.EndConfig[0].Type == clsEndConfig.eType.Seal)
                                {
                                    optMountHoles_Type_CBore_Front.Visible = true;
                                    optMountHoles_Type_Thru_Front.Visible = true;
                                    optMountHoles_Type_Thru_Front.Enabled = false;      //AES 03AUG18
            ...
            //========================      
            {
                ...
                //--------------
                    ...
                    if (modMain.gProject.Product.EndConfig[0].Type == clsEndConfig.eType.Seal)
                    {
                        ...
                        if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                        {
                            txtOD_Front.Text = modMain.gProject.Unit.WriteInUserL(modMain.gProject.Unit.CEng_Met(((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).Mount.Fixture[0].D_Finish));
                            txtL_Front.Text = modMain.gProject.Unit.WriteInUserL(modMain.gProject.Unit.CEng_Met(mEndSeal[0].L));
                        }
                        else
                        {
                            txtOD_Front.Text = modMain.gProject.Unit.WriteInUserL(((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).Mount.Fixture[0].D_Finish);
                            txtL_Front.Text = modMain.gProject.Unit.WriteInUserL(mEndSeal[0].L);
                        }
                        ...
                        //------------------------ 
                            ...
                            if (mEndSeal[0].MountHoles.Type == clsEndConfig.clsMountHoles.eMountHolesType.C)
                            {
                                ...
                                if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                                {
                                    txtMountHoles_D_ThruHole_Front.Text = modMain.gProject.Unit.WriteInUserL(modMain.gProject.Unit.CEng_Met(mEndSeal[0].MountHoles.Screw_Spec.D_Thru));
                                    txtMountHoles_D_CBore_Front.Text = modMain.gProject.Unit.WriteInUserL(modMain.gProject.Unit.CEng_Met(mEndSeal[0].MountHoles.Screw_Spec.D_CBore));
                                    txtMountHoles_CBore_Depth_Front.Text = modMain.gProject.Unit.WriteInUserL(modMain.gProject.Unit.CEng_Met(mEndSeal[0].MountHoles.Depth_CBore));

                                    lblMountHoles_CBoreDepth_LLim_Front.Text = modMain.gProject.Unit.WriteInUserL(modMain.gProject.Unit.CEng_Met(mEndSeal[0].MountHoles.CBore_Depth_LowerLimit()));
                                    lblMountHoles_CBoreDepth_ULim_Front.Text = modMain.gProject.Unit.WriteInUserL(modMain.gProject.Unit.CEng_Met(mEndSeal[0].MountHoles.CBore_Depth_UpperLimit()));
                                }
                                else
                                {
                                    txtMountHoles_D_ThruHole_Front.Text = modMain.gProject.Unit.WriteInUserL(mEndSeal[0].MountHoles.Screw_Spec.D_Thru);
                                    txtMountHoles_D_CBore_Front.Text = modMain.gProject.Unit.WriteInUserL(mEndSeal[0].MountHoles.Screw_Spec.D_CBore);
                                    txtMountHoles_CBore_Depth_Front.Text = modMain.gProject.Unit.WriteInUserL(mEndSeal[0].MountHoles.Depth_CBore);

                                    lblMountHoles_CBoreDepth_LLim_Front.Text = modMain.gProject.Unit.WriteInUserL(mEndSeal[0].MountHoles.CBore_Depth_LowerLimit());
                                    lblMountHoles_CBoreDepth_ULim_Front.Text = modMain.gProject.Unit.WriteInUserL(mEndSeal[0].MountHoles.CBore_Depth_UpperLimit());
                                }
                            }
                            ...
                            else if (mEndSeal[0].MountHoles.Type == clsEndConfig.clsMountHoles.eMountHolesType.T)
                            {
                                ...
                                if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                                {
                                    txtMountHoles_Thread_Depth_Front.Text = modMain.gProject.Unit.WriteInUserL(modMain.gProject.Unit.CEng_Met(mEndSeal[0].MountHoles.Depth_Thread));
                                }
                                else
                                {
                                    txtMountHoles_Thread_Depth_Front.Text = modMain.gProject.Unit.WriteInUserL(mEndSeal[0].MountHoles.Depth_Thread);
                                }
                            }
                            else
                                optMountHoles_Type_CBore_Front.Checked = true;
                ...
                //-------------
                    if (modMain.gProject.Product.EndConfig[1].Type == clsEndConfig.eType.Seal)
                    {
                        ...
                        if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                        {
                            txtOD_Back.Text = modMain.gProject.Unit.WriteInUserL(modMain.gProject.Unit.CEng_Met(((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).Mount.Fixture[1].D_Finish));
                            txtL_Back.Text = modMain.gProject.Unit.WriteInUserL(modMain.gProject.Unit.CEng_Met(mEndSeal[1].L));
                        }
                        else
                        {
                            txtOD_Back.Text = modMain.gProject.Unit.WriteInUserL(((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).Mount.Fixture[1].D_Finish);
                            txtL_Back.Text = modMain.gProject.Unit.WriteInUserL(mEndSeal[1].L);
                        }
                        ...
                        //------------------------ 
                            ...
                            if (mEndSeal[1].MountHoles.Type == clsEndConfig.clsMountHoles.eMountHolesType.C)
                            {
                                ...
                                if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                                {
                                    txtMountHoles_D_ThruHole_Back.Text = modMain.gProject.Unit.WriteInUserL(modMain.gProject.Unit.CEng_Met(mEndSeal[1].MountHoles.Screw_Spec.D_Thru));
                                    txtMountHoles_D_CBore_Back.Text = modMain.gProject.Unit.WriteInUserL(modMain.gProject.Unit.CEng_Met(mEndSeal[1].MountHoles.Screw_Spec.D_CBore));
                                    txtMountHoles_CBore_Depth_Back.Text = modMain.gProject.Unit.WriteInUserL(modMain.gProject.Unit.CEng_Met(mEndSeal[1].MountHoles.Depth_CBore));

                                    lblMountHoles_CBoreDepth_LLim_Back.Text = modMain.gProject.Unit.WriteInUserL(modMain.gProject.Unit.CEng_Met(mEndSeal[1].MountHoles.CBore_Depth_LowerLimit()));
                                    lblMountHoles_CBoreDepth_ULim_Back.Text = modMain.gProject.Unit.WriteInUserL(modMain.gProject.Unit.CEng_Met(mEndSeal[1].MountHoles.CBore_Depth_UpperLimit()));
                                }
                                else
                                {
                                    txtMountHoles_D_ThruHole_Back.Text = modMain.gProject.Unit.WriteInUserL(mEndSeal[1].MountHoles.Screw_Spec.D_Thru);
                                    txtMountHoles_D_CBore_Back.Text = modMain.gProject.Unit.WriteInUserL(mEndSeal[1].MountHoles.Screw_Spec.D_CBore);
                                    txtMountHoles_CBore_Depth_Back.Text = modMain.gProject.Unit.WriteInUserL(mEndSeal[1].MountHoles.Depth_CBore);

                                    lblMountHoles_CBoreDepth_LLim_Back.Text = modMain.gProject.Unit.WriteInUserL(mEndSeal[1].MountHoles.CBore_Depth_LowerLimit());
                                    lblMountHoles_CBoreDepth_ULim_Back.Text = modMain.gProject.Unit.WriteInUserL(mEndSeal[1].MountHoles.CBore_Depth_UpperLimit());
                                }
                            }
                            ...
                            else if (mEndSeal[1].MountHoles.Type == clsEndConfig.clsMountHoles.eMountHolesType.T)
                            {
                                ...
                                if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                                {
                                    txtMountHoles_Thread_Depth_Back.Text = modMain.gProject.Unit.WriteInUserL(modMain.gProject.Unit.CEng_Met(mEndSeal[1].MountHoles.Depth_Thread));
                                }
                                else
                                {
                                    txtMountHoles_Thread_Depth_Back.Text = modMain.gProject.Unit.WriteInUserL(mEndSeal[1].MountHoles.Depth_Thread);
                                }
                            }
                            else
                                optMountHoles_Type_CBore_Back.Checked = true;
                ...
                //==========================================================   
                {
                    ...
                    switch (pTxtBox.Name)
                    {
                        case "txtL_Front":
                            ...
                            if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                            {
                                mEndSeal[0].L = modMain.gProject.Unit.CMet_Eng(modMain.ConvTextToDouble(pTxtBox.Text));
                            }
                            else
                            {
                        ...
                        case "txtL_Back":
                            ...
                            if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                            {
                                mEndSeal[1].L = modMain.gProject.Unit.CMet_Eng(modMain.ConvTextToDouble(pTxtBox.Text));
                            }
                            else
                            {
                        ...
                        case "txtMountHole_Depth_CBore_Front":
                            ...
                            if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                            {
                                Double pMountHole_Depth_CBore_Front = modMain.gProject.Unit.CMet_Eng(modMain.ConvTextToDouble(pTxtBox.Text));
                        ...
                        case "txtMountHole_Depth_CBore_Back":
                            ...
                            if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                            {
                                Double pMountHole_Depth_CBore_Back = modMain.gProject.Unit.CMet_Eng(modMain.ConvTextToDouble(pTxtBox.Text));
                        ...
                        case "txtMountHoles_Thread_Depth_Front":
                            ...
                            if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                            {
                                mEndSeal[0].MountHoles.Depth_Thread = modMain.gProject.Unit.CMet_Eng(modMain.ConvTextToDouble(pTxtBox.Text));
                            }
                            else
                            {
                        ...
                        case "txtMountHoles_Thread_Depth_Back":
                            ...
                            if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                            {
                                mEndSeal[1].MountHoles.Depth_Thread = modMain.gProject.Unit.CMet_Eng(modMain.ConvTextToDouble(pTxtBox.Text));
                            }
                            else
                            {
                                mEndSeal[1].MountHoles.Depth_Thread = modMain.ConvTextToDouble(pTxtBox.Text);
            ...
            //---------------------------------------
                ...
                //======================    
                {
                    ...
                    if (modMain.gProject.Product.EndConfig[0].Type == clsEndConfig.eType.Seal)
                    {
                        ...
                        if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                        {
                            modMain.gProject.Product.EndConfig[0].L = modMain.gProject.Unit.CMet_Eng(modMain.ConvTextToDouble(txtL_Front.Text));
                        }
                        else
                        {
                        ...
                        if (optMountHoles_Type_CBore_Front.Checked)
                        {
                            ...
                            if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                            {
                                modMain.gProject.Product.EndConfig[0].MountHoles.Depth_CBore = modMain.gProject.Unit.CMet_Eng(modMain.ConvTextToDouble(txtMountHoles_CBore_Depth_Front.Text));
                            }
                            else
                            {
                    ...
                    if (modMain.gProject.Product.EndConfig[1].Type == clsEndConfig.eType.Seal)
                    {
                        ...
                        if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                        {
                            modMain.gProject.Product.EndConfig[1].L = modMain.gProject.Unit.CMet_Eng(modMain.ConvTextToDouble(txtL_Back.Text));
                        }
                        else
                        {
                        ...
                        if (optMountHoles_Type_CBore_Back.Checked)
                        {
                            ...
                            if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                            {
                                modMain.gProject.Product.EndConfig[1].MountHoles.Depth_CBore =modMain.gProject.Unit.CMet_Eng( modMain.ConvTextToDouble(txtMountHoles_CBore_Depth_Back.Text));
                            }
                            else
                            {
            ...
            //========================================================================================
            {
                if (modMain.gProject.Unit.System == clsUnit.eSystem.Metric)
                {
                    ...
                    String pMSg = "Enter value between Lower Limit: " +
                                   modMain.ConvDoubleToStr(modMain.gProject.Unit.CEng_Met(Seal_In.MountHoles.CBore_Depth_LowerLimit()), "#0.000") +
                                   " to Upper Limit: " +
                                   modMain.ConvDoubleToStr(modMain.gProject.Unit.CEng_Met(Seal_In.MountHoles.CBore_Depth_UpperLimit()), "#0.000") + ".";
