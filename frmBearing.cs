   ...
   public partial class frmBearing : Form
   {
       ...
       //********************************************
            ...
            //=================
            {
                ...
                //mtxtEDM_Relief = new TextBox[] { txtEDMRelief_Front, txtEDMRelief_Back };              //BG 06DEC12            

                //....Populate Split Configuration.
                cmbSplitConfig.Items.Clear();
                cmbSplitConfig.Items.Add("YES");
                cmbSplitConfig.Items.Add("NO");
            ...
            { 
                ...
                modMain.gDB.PopulateStringCol(pEDMGap, "tblManf_EDM", "fldGap", "", true);
            ...
            {
                int pRecCount = 0;
                string pTblName = "tblData_Mat";
                string pFIELD = "fldName";
                string pWHERE = "";

                //....Base Material.
                pWHERE = "WHERE fldBase = 1";
                pRecCount = modMain.gDB.PopulateCmbBox(cmbMat_Base,pTblName, pFIELD, pWHERE , true);
                if (pRecCount > 0) cmbMat_Base.SelectedIndex = 3;                                       //....Set Index

                //....Lining Material.
                pWHERE = "WHERE fldLining = 1";
                pRecCount = modMain.gDB.PopulateCmbBox(cmbMat_Lining,pTblName, pFIELD, pWHERE , true);
                if (pRecCount > 0) cmbMat_Lining.SelectedIndex = 0;                                     //....Set Index
            }
       ...
       //***************************
            ...
            //========================
            {
                ...
                for (int i = 0; i < 2; i++)
                {
                    mtxtDShaft_Range[i].Text = modMain.ConvDoubleToStr(mBearing_Radial_FP.DShaft_Range[i], "#0.0000#####");    
                    mtxtDFit_Range[i].Text = modMain.ConvDoubleToStr(mBearing_Radial_FP.DFit_Range[i], "#0.0000#####");
                    mtxtDSet_Range[i].Text = modMain.ConvDoubleToStr(mBearing_Radial_FP.DSet_Range[i], "#0.0000");
                    mtxtDPad_Range[i].Text = modMain.ConvDoubleToStr(mBearing_Radial_FP.DPad_Range[i], "#0.0000");
                }
                ...
                //....Lengths
                txtL_Available.Text = modMain.ConvDoubleToStr(modMain.gProject.Product.L_Available, modMain.gUnit.MFormat);
                txtL_Tot.Text = modMain.ConvDoubleToStr(modMain.gProject.Product.L_Tot(), modMain.gUnit.MFormat);
                ...
                //  ====                  
                    ...
                    //...Length  
                    txtPad_L.Text = modMain.ConvDoubleToStr(mBearing_Radial_FP.Pad.L, modMain.gUnit.MFormat);             
                    ...
                    txtPad_T_Lead.Text = modMain.ConvDoubleToStr(mBearing_Radial_FP.Pad.T.Lead, "#0.000");
                    txtPad_T_Pivot.Text = modMain.ConvDoubleToStr(mBearing_Radial_FP.Pad.T.Pivot, "#0.000");
                    txtPad_T_Trail.Text = modMain.ConvDoubleToStr(mBearing_Radial_FP.Pad.T.Trail, "#0.000");
                ...
                //  =============
                    ...
                    txtFlexPivot_Web_T.Text = modMain.ConvDoubleToStr(mBearing_Radial_FP.FlexurePivot.Web.T, "#0.000");
                    txtFlexPivot_Web_RFillet.Text = modMain.ConvDoubleToStr(mBearing_Radial_FP.FlexurePivot.Web.RFillet, "#0.000");
                    txtFlexPivot_Web_H.Text = modMain.ConvDoubleToStr(mBearing_Radial_FP.FlexurePivot.Web.H, "#0.000");
                    
                    if (mBearing_Radial_FP.FlexurePivot.GapEDM != 0.0)
                    {
                        int pIndx = cmbFlexPivot_GapEDM.Items.IndexOf(mBearing_Radial_FP.FlexurePivot.GapEDM.ToString());
                ...
                //  ==========================
                        ...
                        mProduct.EndConfig[1].Type == clsEndConfig.eType.Thrust_Bearing_TL)
                    {
                        ...
                        {
                            txtAxialDist_PadMidPt_ThrustFace.Text = modMain.ConvDoubleToStr(mProduct.Dist_ThrustFace[0], "#0.000");
                            optEndTBPos_Front.Checked = true;
                        }

                        else if ((mProduct.Dist_ThrustFace[0] < modMain.gcEPS) && (mProduct.Dist_ThrustFace[1] > modMain.gcEPS))
                        {
                            txtAxialDist_PadMidPt_ThrustFace.Text = modMain.ConvDoubleToStr(mProduct.Dist_ThrustFace[1], "#0.000");
                ...
                //  ========                  
                    ...
                    txtOilInlet_Orifice_D.Text = modMain.ConvDoubleToStr(mBearing_Radial_FP.OilInlet.Orifice.D, "#0.000");
        ...
        //*****************************
            ...
            //--------------------------------------
                ...
                //=====================
                {
                    ...
                    //  ------------------
                        ...
                        ((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).FlexurePivot.Rot_Stiff = modMain.ConvTextToDouble(txtFlexPivot_Rot_Stiff.Text);        //SB 14APR09
            ...
            //}
                ...
                //==========================================================    
                {
                    ...
                    switch (pTxtBox.Name)
                    {
                        ...
                        //case "txtL_Tot":
                        //    //==============
                        //    //mRadialBearing.L_Tot = modMain.ConvTextToDouble(pTxtBox.Text);    

                        //    if (!mblnL_Tot) return;
                        //    //if (mblnL_Tot)
                        //    //{
                        //    //if (chkRound.Checked)
                        //    //    Display_Calc_Seal_Var();
                        //    //else
                        //        Display_Org_Seal_Var(mRadialBearing);
                        //    //    mblnL_Tot = false;
                        //    //    mblnSeal_L = true;
                        //    //}
                        ...
                        case "txtPad_L":
                            ...
                            //....Total L
                            txtL_Tot.Text = modMain.ConvDoubleToStr(mProduct.L_Tot(), modMain.gUnit.MFormat); 
                            break;
                        ...
                        case "txtPad_T_Trail":
                            ...
                            //case "txtPad_RFillet_ID":          //BG 21MAR13
                            //=================
                            //if (mblnDSet_ManuallyChanged)
                            //{
                            //    ((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).EDM_Pad.RFillet_Back = 0.0;
                        ...
                        ////========================
                        //    mBearing_Radial_FP.EDM_Relief[0] = modMain.ConvTextToDouble(pTxtBox.Text);

                        //    if (Math.Abs(mBearing_Radial_FP.EDM_Relief[0] - mBearing_Radial_FP.DESIGN_EDM_RELIEF) < modMain.gcEPS)
                        //    {
                        ...
                        //    //===================
                        //     mBearing_Radial_FP.EDM_Relief[1] = modMain.ConvTextToDouble(pTxtBox.Text);

                        //    if (Math.Abs(mBearing_Radial_FP.EDM_Relief[1] - mBearing_Radial_FP.DESIGN_EDM_RELIEF) < modMain.gcEPS)
                        //    {
                        //        pTxtBox.ForeColor = Color.Magenta;                                
                        //    }
                        //    else
                        ...
                        case "txtFlexPivot_Web_T":
                            //====================
                             ...
                             {
                                 Double pWeb_RFillet = modMain.MRound(mBearing_Radial_FP.FlexurePivot.Web.T, 0.005);
                        ...
                        case "txtLiningT":
                            ...
                            {
                                txtLiningT.ForeColor = Color.Magenta; //Color.Purple;
                                //txtLiningT.Text = modMain.ConvDoubleToStr(mBearing.MAT_LINING_T, "#0.000");
                            }
                            else
                            {
                                txtLiningT.ForeColor = Color.Black;
                                //txtLiningT.Text = modMain.ConvDoubleToStr(mBearing.LiningT, "#0.000");
                            }
                ...
                //======================================================    
                {
                    if (T_Pivot_In != 0.0)
                    {
                        txtPad_T_Lead.Text = modMain.ConvDoubleToStr(T_Pivot_In, "#0.000");
                        txtPad_T_Trail.Text = modMain.ConvDoubleToStr(T_Pivot_In, "#0.000");
            ...
            //---------------------------------
               ...
               //AM 14AUG12
                //private void Set_Pad_Pivot_AngStart(string Type_In)    
                ////=================================================
                //{
                //    if (Type_In == "LBP")
                //    {
                //        if (modMain.gPivot_AngStart_LBP != 0.0)
                //        {
                //            txtPad_Pivot_AngStart.Text = Convert.ToString(modMain.gPivot_AngStart_LBP);
                //        }
                //        else
                //        {
                //            txtPad_Pivot_AngStart.Text = Convert.ToString(mBearing_Radial_FP.Pad.Pivot.AngStart);
                //        }
                //    }
                //    else if (Type_In == "LOP")
                //    {
                //        if (modMain.gPivot_AngStart_L0P != 0.0)
                //        {
                //            txtPad_Pivot_AngStart.Text = Convert.ToString(modMain.gPivot_AngStart_L0P);
                //        }
                //        else
                //        {
                //            txtPad_Pivot_AngStart.Text = Convert.ToString(mBearing_Radial_FP.Pad.Pivot.AngStart);
                ...
                //============================================================   
                {
                    ...
                    switch (pChkBox.Name)
                    {
                        case "chkThick_Pivot":
                            //----------------
                               Set_Pad_T_Design();
                               //Set_Pad_T_Lead_AND_Trail(txtPad_T_Pivot); 
                               //chkThick_Pivot.Checked = ((clsBearing_Radial_FP)modMain.gProject.Product.Bearing).Pad.T.Pivot_Checked;
