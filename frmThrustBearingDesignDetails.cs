        ...
        //*****************************
            ...
            //========================
            {
                if (modMain.gProject.Product.EndConfig[0].Type == clsEndConfig.eType.Thrust_Bearing_TL)
                {
                    ...
                    txtL_Front.Text = mEndTB[0].L.ToString("#0.000");     //BG 07DEC12

                    txtLFlange_Front.Text = mEndTB[0].LFlange.ToString("#0.000");
                    txtDimStart_Front.Text = modMain.ConvDoubleToStr(mEndTB[0].DimStart(),"#0.0000");       //BG 24APR12
                    txtFaceOff_Assy_Front.Text = mEndTB[0].FaceOff_Assy.ToString("#0.000");
                    ...
                    txtMountHoles_D_ThruHole_Front.Text = modMain.ConvDoubleToStr(mEndTB[0].MountHoles.Screw_Spec.D_Thru, "#0.000");

                    txtMountHoles_D_CBore_Front.Text = modMain.ConvDoubleToStr(mEndTB[0].MountHoles.Screw_Spec.D_CBore, "#0.000");
                    txtMountHoles_CBore_Depth_Front.Text = mEndTB[0].MountHoles.Depth_CBore.ToString("#0.000");
                    lblMountHoles_CBoreDepth_LLim_Front.Text = modMain.ConvDoubleToStr(mEndTB[0].MountHoles.CBore_Depth_LowerLimit(), "#0.000");
                    lblMountHoles_CBoreDepth_ULim_Front.Text = modMain.ConvDoubleToStr(mEndTB[0].MountHoles.CBore_Depth_UpperLimit(), "#0.000");
                    
                    chkMountHoles_Thread_Thru_Front.Checked = mEndTB[0].MountHoles.Thread_Thru;
                    txtMountHoles_Thread_Depth_Front.Text = mEndTB[0].MountHoles.Depth_Thread.ToString("#0.000");
                    ...
                    {
                        txtBackRelief_D_Front.Text = mEndTB[0].BackRelief.D.ToString("#0.000");
                        txtBackRelief_Depth_Front.Text = mEndTB[0].BackRelief.Depth.ToString("#0.000");
                        txtBackRelief_Fillet_Front.Text = mEndTB[0].BackRelief.Fillet.ToString("#0.000");
                    }

                    //....Feed Groove
                    cmbFeedGroove_Type_Front.Text =mEndTB[0].FeedGroove.Type ;
                    txtFeedGroove_DBC_Front.Text = mEndTB[0].FeedGroove.DBC.ToString("#0.000");
                    txtFeedGroove_Dist_Chamf_Front.Text = mEndTB[0].FeedGroove.Dist_Chamf.ToString("#0.000");
                }

                if (modMain.gProject.Product.EndConfig[1].Type == clsEndConfig.eType.Thrust_Bearing_TL)
                {
                    txtRotation_Back.Text = clsBearing_Thrust_TL.eRotation.CW.ToString();
                    txtL_Back.Text = mEndTB[1].L.ToString("#0.000");

                    txtLFlange_Back.Text = mEndTB[1].LFlange.ToString("#0.000");
                    ...
                    txtMountHoles_D_ThruHole_Back.Text = modMain.ConvDoubleToStr(mEndTB[1].MountHoles.Screw_Spec.D_Thru, "#0.000");

                    txtMountHoles_D_CBore_Back.Text = modMain.ConvDoubleToStr(mEndTB[1].MountHoles.Screw_Spec.D_CBore, "#0.000");
                    txtMountHoles_CBore_Depth_Back.Text = mEndTB[1].MountHoles.Depth_CBore.ToString("#0.000");
                    lblMountHoles_CBoreDepth_LLim_Back.Text = modMain.ConvDoubleToStr(mEndTB[1].MountHoles.CBore_Depth_LowerLimit(), "#0.000");
                    lblMountHoles_CBoreDepth_ULim_Back.Text = modMain.ConvDoubleToStr(mEndTB[1].MountHoles.CBore_Depth_UpperLimit(), "#0.000");

                    chkMountHoles_Thread_Thru_Back.Checked = mEndTB[1].MountHoles.Thread_Thru;
                    txtMountHoles_Thread_Depth_Back.Text = mEndTB[1].MountHoles.Depth_Thread.ToString("#0.000");
                    ...
                    {
                        txtBackRelief_D_Back.Text = mEndTB[1].BackRelief.D.ToString("#0.000");
                        txtBackRelief_Depth_Back.Text = mEndTB[1].BackRelief.Depth.ToString("#0.000");
                        txtBackRelief_Fillet_Back.Text = mEndTB[1].BackRelief.Fillet.ToString("#0.000");
                    }

                    //....Feed Groove
                    cmbFeedGroove_Type_Back.Text = mEndTB[1].FeedGroove.Type;
                    txtFeedGroove_DBC_Back.Text = mEndTB[1].FeedGroove.DBC.ToString("#0.000");
                    txtFeedGroove_Dist_Chamf_Back.Text = mEndTB[1].FeedGroove.Dist_Chamf.ToString("#0.000");
                }
            }
                    ...
                    switch (pTxtBox.Name)
                    {
                        case "txtL_Front":
                            //------------
                                ...
                                SetTxtForeColor_L(txtL_Front, modMain.gProject.Product.Calc_L_EndConfig());        //BG 07DEC12
                            break;
