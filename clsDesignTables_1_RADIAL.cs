...
//                                                                              '
//                          SOFTWARE  :  "BearingCAD"                           '
//                      CLASS MODULE  :  clsDesignTables_1_RADIAL               '
//                        VERSION NO  :  2.0                                    '
//                      DEVELOPED BY  :  AdvEnSoft, Inc.                        '
//                     LAST MODIFIED  :  24AUG12                                '
//                                                                              '
//===============================================================================
//
//Routines
...
namespace BearingCAD20
{
    partial class clsDesignTables
    {
        ...
        private const string mcRadial_Title = "RADIAL BEARING";
                    ...
                    for (int i = 0; i < pSoftware_VarName.Count; i++)
                    {
                        ...
                        if (pSoftware_VarName[i] != "")
                        {
                            switch (pSoftware_VarName[i])
                            {
                                ...
                                case "gProject.Product.Bearing.DESIGN_EDM_RELIEF1":                            //Col. IT
                                    //--------------------------------------------        
                                ...
                                case "gProject.Product.Bearing.DESIGN_EDM_RELIEF2":                            //Col. IU
                                    //--------------------------------------------        
        ...
        #region "EXCEL MAPPING:"
            ...
            private void Populate_EXCEL_Radial(clsFiles Files_In, clsProject Project_In, clsDB DB_In, string FilePath_In)
            //===========================================================================================================       
            {
                try
                {
                    ...
                    String pFileName = FilePath_In + "\\" + mcRadial_Title + ".xlsx";
