        ...
        //==================
        {
            ...
            #region "CLASS METHODS":
                ...
                //====================
                {
                    ...
                    pstrFIELDS = "fldAngle ";
                    pstrFROM = "FROM tblDesign_Pad ";
                    pstrWHERE = "WHERE fldQty = " + mCount;
                    ...
                    pDR = mCurrent_Bearing_Radial_FP.mDB.GetDataReader(pstrSQL, ref pConnection);

                    Double pAngle = 0.0f;
                    if (pDR.Read())
                    {
                        pAngle = Convert.ToDouble(pDR["fldAngle"]);
                    }
                    pDR.Close();
                    pConnection.Close();
                ...
                public Double RFillet_ID()      //PB 23FEB12. To be written
                //========================
                {
                    //....Retrieve from database.
                    //
                    string pstrTblName, pstrFIELDS, pstrFROM, pstrWHERE, pstrSQL;
                    pstrTblName = "tblDesign_Pad_Fillet";
                    pstrFIELDS = "fldR";
                    pstrFROM = " FROM " + pstrTblName;
                    pstrWHERE = " WHERE fldDSet_LLim <=" + mCurrent_Bearing_Radial_FP.DSet() +
                                " AND fldDSet_ULim > = " + mCurrent_Bearing_Radial_FP.DSet();
                    ...
                    if (pDR.Read())
                    {
                        pR = Convert.ToDouble(pDR[pstrFIELDS]);
                    }
                    pDR.Close();
                    pConnection.Close();
