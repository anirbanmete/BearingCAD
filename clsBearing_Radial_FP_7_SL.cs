            ...
            #region "CLASS METHODS":
                ...
                //-------------
                    ...
                    //------------------
                        ...
                        //private Double Calc_Screw_Loc_Front(string Screw_In)
                    ...
                    //-----------------------------
                        ...
                        //==================================
                        {
                            ...
                            pFIELDS = "fldD ";
                            pFROM = "FROM tblManf_Screw_D ";
                            pWHERE = "WHERE fldD_Desig = '" + mScrew_Spec.D_Desig + "'";
                            ...
                            //
                            if (pDR.Read())
                                pDThread = mCurrent_Bearing_Radial_FP.mDB.CheckDBDouble(pDR, "fldD");
