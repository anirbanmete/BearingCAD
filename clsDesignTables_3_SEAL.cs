...
//                                                                              '
//                          SOFTWARE  :  "BearingCAD"                           '
//                      CLASS MODULE  :  clsDesignTables_3_SEAL                 '
//                        VERSION NO  :  2.0                                    '
//                      DEVELOPED BY  :  AdvEnSoft, Inc.                        '
//                     LAST MODIFIED  :  11JUN12                                '
//                                                                              '
//===============================================================================
//
//Routines
...
namespace BearingCAD20
{
    partial class clsDesignTables
    {
        ...
        private const string mcSeal_Title = "SEAL";
                            ...
                            switch (pSoftware_VarName[i])
                            {
                                ...
                                case "gProject.Product.EndConfig[i].DrainHoles.AngStart_FrontMounted":  //Col. AE    
                                        ...
                                        Project_In.Product.EndConfig[1].Type == clsEndConfig.eType.Seal)
                                    {
                                        ...
                                        {
                                            pDrainHoles_AngStart_Front = modMain.ConvDoubleToStr(mEndSeal[0].DrainHoles.AngStart_FrontMounted, "");
                                            pDrainHoles_AngStart_Back = modMain.ConvDoubleToStr(mEndSeal[0].DrainHoles.AngStart_BackMounted, "");
                                        }
                                    ...
                                    else if (Project_In.Product.EndConfig[1].Type == clsEndConfig.eType.Seal)
                                    {
                                        ...
                                        {
                                            pDrainHoles_AngStart_Back = modMain.ConvDoubleToStr(mEndSeal[1].DrainHoles.AngStart_FrontMounted, "");
                                        }
                                    }
        ...
        #region "EXCEL MAPPING:"
            ...
            private void Populate_EXCEL_Seal(clsFiles Files_In, clsProject Project_In,
            ...
            //===========================================================================    
            {
                try
                {
                    ...
                    String pFileName = FileName_In + "\\" + mcSeal_Title + ".xlsx";
