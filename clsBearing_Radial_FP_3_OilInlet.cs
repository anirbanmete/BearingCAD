    ...
    public partial class clsBearing_Radial_FP : clsBearing_Radial
    {
        ...
        //======================
        {
            ...
            //=========================
                ...
                //private eOrificeStartPos mOrificeStartPos;      //PB 18APR12.  BG, bring this under the structure sOrifice.   //BG 19APR12

                //private Double mDDrill_CBore;               //PB 18APR12.  BG, bring this under the structure sOrifice.       //BG 19APR12

                //private Double mLocFeedHole_FrontFace;    //PB 18APR12.  BG, change the GUI & DB accordingly.
                //private Double mLoc_Orifice_FrontFace;
                //private Double mAngStart_Feed_BDV;        //PB 18APR12.  BG, change the GUI & DB accordingly.
                //private Double mAngStart_Orifice_BDV;
                //private Double mDist_FeedHoles;      //....If Orifice_Count =   Count_Pad, Dist_FeedHole = 0 (irrelevant).
                ////                                                          = 2*Count_Pad, Dist_FeedHole > 0.
                //private Double mDist_OrificeHoles;      //....If Orifice_Count =   Count_Pad, Dist_FeedHole = 0 (irrelevant).
                //                                                          = 2*Count_Pad, Dist_FeedHole > 0.

                //PB 18APR12. BG, move the above Orifice variables into the structure, as shown above. Modify the code accordingly.
            ...
            //================================ 
                ...
                //---------------------
                    ...
                    //public eOrificeStartPos OrificeStartPos
                    //{
                    //    get { return mOrificeStartPos; }
                    //    set
                    //    {
                    //        mOrificeStartPos = value;
                    //        mAngStart_Orifice_BDV = Calc_AngStart_Feed_BDV();
                    //    }
                    //}
    

                    //public Double DDrill_CBore                      //....Read-only.
                    //{
                    //    get
                    //    {
                    //        //if (mDDrill_CBore < modMain.gcEPS)
                    //        mDDrill_CBore = Calc_DDrill_CBore();
                    //        return mDDrill_CBore;
                    //    }

                    //    //set { mDDrill_CBore = value; }
                    //}


                    //public Double LocFeedHole_FrontFace
                    //{
                    //    get
                    //    {
                    //        if (mLoc_Orifice_FrontFace < modMain.gcEPS)
                    //            mLoc_Orifice_FrontFace = Calc_LocFeedHole_FrontFace();
                    //        return mLoc_Orifice_FrontFace;
                    //    }

                    //    set { mLoc_Orifice_FrontFace = value; }
                    //}


                    //public Double AngStart_Feed_BDV                //....Read-only. 
                    //{
                    //    get
                    //    {
                    //        //if (mAngStart_Feed_BDV < modMain.gcEPS)
                    //        mAngStart_Orifice_BDV = Calc_AngStart_Feed_BDV();
                    //        return mAngStart_Orifice_BDV;
                    //    }

                    //    //set { mAngStart_Feed_BDV = value; }
                    //}


                    //public Double Dist_FeedHoles
                    //{
                    //    get
                    //    {
                    //        if (mDist_OrificeHoles < modMain.gcEPS)
                    //            mDist_OrificeHoles = Calc_Dist_FeedHole();

                    //        return mDist_OrificeHoles;
                    //    }

                    //    set { mDist_OrificeHoles = value; }
                    //}
            ...
            #region "CLASS METHODS":
                ...
                #region "ORIFICE:"
                    ...
                    //==========================================   
                    {
                        ...
                        if (!Orifice_Exists_2ndSet())
                        {
                            ...
                            //....Incorrect formula given in above Design table. 
                            //........This is true only when the DepthF & B are equal.
                            //pVal = pDepthB + mc_DESIGN_EDM_RELIEF + (0.5 * mCurrent_Bearing_Radial_FP.Pad.L);

                            //....Correct formula for now.   //PB 16APR12.
                            //........To be corrected again when unequal EDM Reliefs on the FRONT & BACK sides are enabled in the future.
                            //pVal = pDepthF + mc_DESIGN_EDM_RELIEF + (0.5 * mCurrent_Bearing_Radial_FP.Pad.L);

                            //....29JUN12. Unequal EDM relief at Front & Back accounted for.
                            //pVal = pDepthF + mCurrent_Bearing_Radial_FP.EDM_Relief[0] + (0.5 * mCurrent_Bearing_Radial_FP.Pad.L); 
                            pVal = pDepthF + mCurrent_Bearing_Radial_FP.MillRelief.EDM_Relief[0] + (0.5 * mCurrent_Bearing_Radial_FP.Pad.L);    //BG 06DEC12
                        }
                        ...
                        {
                            //....# of Orifice Sets = 2.
                            //PB 20JAN12 Incorrect Formula, ask HK. This is true only when the DepthF & B are equal.
                            //pVal = pDepthB + mc_DESIGN_EDM_RELIEF + (mCurrent_Bearing_Radial_FP.Pad.L / 2.5);

                            //PB 18APR12. The following formula is valid when the the Distance between Orifice Holes is 0.2 
                            //....of the Pad Length and the orifice sets are placed symmetrically about pad midsection 
                            //........i.e 0.4 X Pad Length from the edge. 
                            //
                            //pVal = pDepthF + mc_DESIGN_EDM_RELIEF + (mCurrent_Bearing_Radial_FP.Pad.L / 2.5);

                            //....29JUN12. Unequal EDM relief at Front & Back accounted for.
                            //pVal = pDepthF + mCurrent_Bearing_Radial_FP.EDM_Relief[0] + (mCurrent_Bearing_Radial_FP.Pad.L / 2.5); //BG 06DEC12
                            pVal = pDepthF + mCurrent_Bearing_Radial_FP.MillRelief.EDM_Relief[0] + (mCurrent_Bearing_Radial_FP.Pad.L / 2.5);    //BG 06DEC12

                            //The above formula to be corrected when the user changes the distance from the above default value.
                        }
                ...
                #region "MAIN:"
                    ...
                    //======================================
                    {
                        //....Ref. Radial_Rev11_27OCT11: Col. DR  
                        ...
                        if (Orifice_Exists_2ndSet())
                            //....# of Orifice Sets = 2.
                            //PB 20JAN12 Incorrect Formula, ask HK. This is true only when the DepthF & B are equal.
                            //pVal = 2 * (pDepthB + mc_DESIGN_EDM_RELIEF + 0.5 * pPadL - mLocFeedHole_FrontFace);

                            //....Based on the the communications with Harout K., Waukesha Bearings, 17APR12.
                            pVal = 0.2 * pPadL;         //PB 17APR12.
